  ...
  try {
      ...
      var z = (function (z) {
        ...
        return (
            ...
            app["NetAgent"]["AddListener2Lobby"](
              ...
              Laya["Handler"]["create"](
                ...
                function (C) {
                  ...
                  z &&
                    z.bag &&
                    (B["update_data"](z.bag["update_items"]),
                    B["update_daily_gain_data"](z.bag));
                },
                null,
                !1
              )
                          ...
                          for (
                            ...
                            if (A)
                              for (var O = 0; O < A["length"]; O++)
                                C["_daily_gain_record"][d][A[O]["item_id"]] =
                                  A[O]["count"];
                          }
                      }
                    }
                    ...
                    for (
                      ...
                      if (d)
                        for (var f = 0; f < d["length"]; f++)
                          this["_daily_gain_record"][E][d[f]["item_id"]] =
                            d[f]["count"];
                    }
                }
              }
          ...
          (e["get_item_count"] = function (B) {
            ...
            if ("100001" == B) {
              for (
                var z = 0, e = 0, I = GameMgr.Inst["free_diamonds"];
                e < I["length"];
                e++
              ) {
                var p = I[e];
                GameMgr.Inst["account_numerical_resource"][p] &&
                  (z += GameMgr.Inst["account_numerical_resource"][p]);
              }
              for (
                var L = 0, R = GameMgr.Inst["paid_diamonds"];
                L < R["length"];
                L++
              ) {
                var p = R[L];
            ...
            if ("100004" == B) {
              for (
                var E = 0, V = 0, d = GameMgr.Inst["free_pifuquans"];
                V < d["length"];
                V++
              ) {
                var p = d[V];
                GameMgr.Inst["account_numerical_resource"][p] &&
                  (E += GameMgr.Inst["account_numerical_resource"][p]);
              }
              for (
                var f = 0, A = GameMgr.Inst["paid_pifuquans"];
                f < A["length"];
                f++
              ) {
                var p = A[f];
          ...
          (e["find_items_by_category"] = function (B, C) {
            ...
            for (var e in this["_item_map"])
              this["_item_map"][e]["category"] == B &&
                this["_item_map"][e]["count"] &&
                z.push({
            ...
            return (
              C &&
                z.sort(function (B, z) {
                  return (
                    cfg["item_definition"].item.get(B["item_id"])[C] -
                    cfg["item_definition"].item.get(z["item_id"])[C]
                  );
                }),
              z
            );
          ...
          (e["update_data"] = function (C) {
            for (var z = 0; z < C["length"]; z++) {
              ...
              if (I > 0) {
                ...
                1 == p["category"] &&
                  ...
                  5 == p["category"] &&
                    (this["new_bag_item_ids"].push(e),
                    (this["new_zhuangban_item_ids"][e] = 1)),
                  8 != p["category"] ||
                    p["item_expire"] ||
                    this["new_cg_ids"].push(e);
            ...
            for (var z = 0; z < C["length"]; z++) {
              ...
              if (this["_item_listener"]["hasOwnProperty"](e["toString"]()))
                for (
                  var R = this["_item_listener"][e], E = 0;
                  E < R["length"];
                  E++
                )
                  R[E].run();
              ...
              for (var z = 0; z < C["length"]; z++) {
                ...
                if (p)
                  for (var L = 0; L < p["length"]; L++)
                    this["_daily_gain_record"][e][p[L]["item_id"]] =
                      p[L]["count"];
              }
          }),
          (e["get_item_daily_record"] = function (B, C) {
            return this["_daily_gain_record"][B]
              ? this["_daily_gain_record"][B]["record_time"]
                ? game["Tools"]["isPassedRefreshTimeServer"](
                    this["_daily_gain_record"][B]["record_time"]
                  )
                  ? this["_daily_gain_record"][B][C]
                    ? this["_daily_gain_record"][B][C]
                    : 0
                  : 0
                : 0
          ...
          (e["add_item_listener"] = function (B, C) {
            this["_item_listener"]["hasOwnProperty"](B["toString"]()) ||
              (this["_item_listener"][B] = []),
          ...
          (e["remove_all_item_listener"] = function (B) {
            for (
              var C = this["_all_item_listener"], z = 0;
              z < C["length"];
              z++
            )
              if (C[z] === B) {
                (C[z] = C[C["length"] - 1]), C.pop();
                break;
              }
          }),
          ...
          (e["checkItemEnough"] = function (B) {
            for (var C = B["split"](","), z = 0, I = C; z < I["length"]; z++) {
              ...
              if (p) {
                var L = p["split"]("-");
                if (e["get_item_count"](Number(L[0])) < Number(L[1])) return !1;
              }
            }
            return !0;
          }),
            ...
            (this["container_top"] = this.me["getChildByName"]("top")),
              (this["container_top"]["getChildByName"]("btn_back")[
                ...
                function () {
                  C["locking"] ||
                    C.hide(
                      Laya["Handler"]["create"](C, function () {
                        return C["closeHandler"]
                          ? (C["closeHandler"].run(),
                            (C["closeHandler"] = null),
                            void 0)
                          : ((B["UI_Lobby"].Inst["enable"] = !0), void 0);
                      })
                    );
                },
                null,
            ...
            for (
              var z = function (B) {
                  e.tabs.push(
                    e["container_content"]
                      ["getChildByName"]("tabs")
                      ["getChildByName"]("btn" + B)
                  ),
                    (e.tabs[B]["clickHandler"] = Laya["Handler"]["create"](
                      e,
                      function () {
          ...
          (e["prototype"].hide = function (C) {
            ...
            (this["locking"] = !0),
              ...
              Laya["timer"].once(300, this, function () {
                (z["locking"] = !1), (z["enable"] = !1), C && C.run();
              });
          }),
          ...
          (e["prototype"]["on_change_tab"] = function (B) {
            ...
            for (var z = 0; z < this.tabs["length"]; z++)
              (this.tabs[z].skin = game["Tools"]["localUISrc"](
                B == z
                  ? "myres/shop/tab_choose.png"
                  : "myres/shop/tab_unchoose.png"
              )),
                (this.tabs[z]["getChildAt"](0)["color"] =
                  B == z ? "#d9b263" : "#8cb65f");
            switch (
              (this["page_item"]["close"](),
              this["page_gift"]["close"](),
        ...
        return (
          ...
          (C["prototype"]["OpenConnect"] = function (C, z, e, I) {
            ...
            uiscript["UI_Loading"].Inst.show("enter_mj"),
              B["Scene_Lobby"].Inst &&
                B["Scene_Lobby"].Inst["active"] &&
                (B["Scene_Lobby"].Inst["active"] = !1),
              B["Scene_Huiye"].Inst &&
                B["Scene_Huiye"].Inst["active"] &&
                (B["Scene_Huiye"].Inst["active"] = !1),
              this["Close"](),
          ...
          (C["prototype"]["reportInfo"] = function () {
            this["connect_state"] == B["EConnectState"]["connecting"] &&
              GameMgr.Inst["postNewInfo2Server"]("network_route", {
                client_type: "web",
                route_type: "game",
                route_index:
                  B["LobbyNetMgr"]["root_id_lst"][
                    B["LobbyNetMgr"].Inst["choosed_index"]
                  ],
          ...
          (C["prototype"]["_OnConnent"] = function (C) {
            app.Log.log("MJNetMgr _OnConnent event:" + C),
              C == Laya["Event"]["CLOSE"] || C == Laya["Event"]["ERROR"]
                ? Laya["timer"]["currTimer"] - this["lasterrortime"] > 100 &&
                  ((this["lasterrortime"] = Laya["timer"]["currTimer"]),
                  this["connect_state"] == B["EConnectState"]["tryconnect"]
                    ? this["_try_to_linknext"]()
                    : this["connect_state"] == B["EConnectState"]["connecting"]
                    ? view["DesktopMgr"].Inst["active"]
                      ? ((view["DesktopMgr"].Inst["duringReconnect"] = !0),
                        this["_setState"](B["EConnectState"]["reconnecting"]),
                        (this["reconnect_count"] = 0),
                        this["_Reconnect"]())
                      : (this["_setState"](B["EConnectState"]["disconnect"]),
                        uiscript["UIMgr"].Inst["ShowErrorInfo"](
                          B["Tools"]["strOfLocalization"](2008)
                        ),
                        B["Scene_MJ"].Inst["ForceOut"]())
                    : this["connect_state"] ==
                        B["EConnectState"]["reconnecting"] &&
                      this["_Reconnect"]())
                : C == Laya["Event"].OPEN &&
                  ...
                  (this["connect_state"] == B["EConnectState"]["tryconnect"] ||
                    ...
                    this["_setState"](B["EConnectState"]["connecting"]),
                    this["is_ob"]
          ...
          (C["prototype"]["_Reconnect"] = function () {
            var C = this;
            B["LobbyNetMgr"].Inst["connect_state"] == B["EConnectState"].none ||
            B["LobbyNetMgr"].Inst["connect_state"] ==
              B["EConnectState"]["disconnect"]
              ? this["_setState"](B["EConnectState"]["disconnect"])
              : B["LobbyNetMgr"].Inst["connect_state"] ==
                  B["EConnectState"]["connecting"] && GameMgr.Inst["logined"]
                ...
                : (Laya["timer"].once(
                    ...
                    function () {
                      C["connect_state"] ==
                        B["EConnectState"]["reconnecting"] &&
                        (app.Log.log(
                          "MJNetMgr reconnect count:" + C["reconnect_count"]
                        ),
          ...
          (C["prototype"]["_try_to_linknext"] = function () {
            this["link_index"]++,
              ...
              this["link_index"] >= this.urls["length"]
                ? B["LobbyNetMgr"].Inst["polling_connect"]
                  ? (this["lb_index"]++, this["_fetch_gateway"](0))
                  : (this["_setState"](B["EConnectState"].none),
                    uiscript["UIMgr"].Inst["ShowErrorInfo"](
                      B["Tools"]["strOfLocalization"](59)
                    ),
                    this["_SendDebugInfo"](),
          ...
          (C["prototype"]["_fetch_gateway"] = function (C) {
            ...
            if (
              B["LobbyNetMgr"].Inst["polling_connect"] &&
              this["lb_index"] >= B["LobbyNetMgr"].Inst.urls["length"]
            )
              return (
                uiscript["UIMgr"].Inst["ShowErrorInfo"](
                  B["Tools"]["strOfLocalization"](59)
            ...
            var e = function (e) {
                var I = JSON["parse"](e);
                if (
                  (app.Log.log("mj _fetch_gateway func_success data = " + e),
                  I["maintenance"])
                )
                  z["_setState"](B["EConnectState"].none),
                    uiscript["UIMgr"].Inst["ShowErrorInfo"](
                      B["Tools"]["strOfLocalization"](2009)
                    ),
                    view["DesktopMgr"].Inst &&
                      !view["DesktopMgr"].Inst["active"] &&
                      B["Scene_MJ"].Inst["ForceOut"]();
                  ...
                  (z["link_index"] = -1), z["_try_to_linknext"]();
                } else
                  1 > C
                    ...
                    : B["LobbyNetMgr"].Inst["polling_connect"]
                    ? (z["lb_index"]++, z["_fetch_gateway"](0))
                    : (uiscript["UIMgr"].Inst["ShowErrorInfo"](
                        B["Tools"]["strOfLocalization"](60)
                      ),
                      z["_SendDebugInfo"](),
                      view["DesktopMgr"].Inst &&
                        !view["DesktopMgr"].Inst["active"] &&
              ...
              I = function () {
                app.Log.log("mj _fetch_gateway func_error"),
                  1 > C
                    ? Laya["timer"].once(500, z, function () {
                        z["_fetch_gateway"](C + 1);
                      })
                    : B["LobbyNetMgr"].Inst["polling_connect"]
                    ? (z["lb_index"]++, z["_fetch_gateway"](0))
                    : (uiscript["UIMgr"].Inst["ShowErrorInfo"](
                        B["Tools"]["strOfLocalization"](58)
                      ),
                      z["_SendDebugInfo"](),
                      view["DesktopMgr"].Inst["active"] ||
                        B["Scene_MJ"].Inst["ForceOut"](),
            ...
            B["LobbyNetMgr"].Inst["polling_connect"]
              ? p(B["LobbyNetMgr"].Inst.urls[this["lb_index"]])
              : p(B["LobbyNetMgr"].Inst["lb_url"]);
          }),
          (C["prototype"]["_setState"] = function (C) {
            (this["connect_state"] = C),
              GameMgr["inRelease"] ||
                (null != uiscript["UI_Common"].Inst &&
                  (C == B["EConnectState"].none
                    ? (uiscript["UI_Common"].Inst["label_net_mj"].text = "")
                    : C == B["EConnectState"]["tryconnect"]
                    ? ((uiscript["UI_Common"].Inst["label_net_mj"].text =
                        "尝试连接麻将服务器"),
                      (uiscript["UI_Common"].Inst["label_net_mj"]["color"] =
                        "#000000"))
                    : C == B["EConnectState"]["connecting"]
                    ? ((uiscript["UI_Common"].Inst["label_net_mj"].text =
                        "麻将服务器：正常"),
                      (uiscript["UI_Common"].Inst["label_net_mj"]["color"] =
                        "#00ff00"))
                    : C == B["EConnectState"]["disconnect"]
                    ? ((uiscript["UI_Common"].Inst["label_net_mj"].text =
                        "麻将服务器：断开连接"),
                      (uiscript["UI_Common"].Inst["label_net_mj"]["color"] =
                        "#ff0000"),
                    ...
                    : C == B["EConnectState"]["reconnecting"] &&
                      ((uiscript["UI_Common"].Inst["label_net_mj"].text =
                        "麻将服务器：正在重连"),
                      (uiscript["UI_Common"].Inst["label_net_mj"]["color"] =
                        "#ff0000"),
          ...
          (C["prototype"]["_ConnectSuccess"] = function () {
            ...
            app.Log.log("MJNetMgr _ConnectSuccess "),
              ...
              app["NetAgent"]["sendReq2MJ"](
                ...
                function (z, e) {
                  if (z || e["error"])
                    uiscript["UIMgr"].Inst["showNetReqError"]("authGame", z, e),
                      B["Scene_MJ"].Inst["GameEnd"](),
                    ...
                    if (MMP.settings.setbianjietishi) {
                      e["game_config"]["mode"]["detail_rule"][
                        "bianjietishi"
                      ] = true;
                    }
                    // END
                    ...
                    R.mode < 10
                      ? ((E = view["ERuleMode"]["Liqi4"]),
                        (C["real_player_count"] = 4))
                      : R.mode < 20 &&
                        ((E = view["ERuleMode"]["Liqi3"]),
                        (C["real_player_count"] = 3));
                    for (var V = 0; V < C["real_player_count"]; V++)
                      I.push(null);
                    R["extendinfo"] &&
                      (L = B["Tools"]["strOfLocalization"](2004)),
                      R["detail_rule"] &&
                        R["detail_rule"]["ai_level"] &&
                        (1 === R["detail_rule"]["ai_level"] &&
                        ...
                        for (var O = 0; O < e["players"]["length"]; O++)
                          if (e["players"][O]["account_id"] == A) {
                            ...
                            if (I[V].account_id == GameMgr.Inst.account_id) {
                              ...
                              (I[V].avatar_id == 400101 ||
                                I[V].avatar_id == 400201)
                            ) {
                              //玩家如果用了默认皮肤也随机换
                              let all_keys = Object.keys(
                                cfg.item_definition.skin.map_
                      ...
                      function (C, z) {
                        C || z["error"]
                          ...
                          : (app.Log.log("[syncGame] " + JSON["stringify"](z)),
                            z["isEnd"]
                              ? (uiscript["UIMgr"].Inst["ShowErrorInfo"](
                                  B["Tools"]["strOfLocalization"](2011)
                                ),
                                B["Scene_MJ"].Inst["GameEnd"]())
            ...
            app.Log.log("正常进入游戏: " + JSON["stringify"](C)),
              C["is_end"]
                ? (uiscript["UIMgr"].Inst["ShowErrorInfo"](
                  ...
                  B["Scene_MJ"].Inst["GameEnd"]())
                : C["game_restore"]
                ? view["DesktopMgr"].Inst["syncGameByStep"](C["game_restore"])
                : ((this["load_over"] = !0),
                  this["load_over"] &&
                    uiscript["UI_Loading"].Inst["enable"] &&
                    uiscript["UI_Loading"].Inst["showLoadCount"](
          ...
          (C["prototype"]["_PlayerReconnectSuccess"] = function (C) {
            app.Log.log("_PlayerReconnectSuccess data:" + JSON["stringify"](C)),
              C["isEnd"]
                ...
                ? view["DesktopMgr"].Inst["syncGameByStep"](C["game_restore"])
                : (uiscript["UIMgr"].Inst["ShowErrorInfo"](
                    B["Tools"]["strOfLocalization"](2012)
                  ),
                  B["Scene_MJ"].Inst["ForceOut"]());
          }),
                ...
                function (z, e) {
                  z || e["error"]
                    ? (uiscript["UIMgr"].Inst["showNetReqError"](
                      ...
                      B["Scene_MJ"].Inst["GameEnd"](),
                      view["BgmListMgr"]["PlayLobbyBgm"]())
                    : (app.Log.log("实时OB验证通过：" + JSON["stringify"](e)),
                        ...
                        function (z, e) {
                          if (z || e["error"])
                            ...
                            for (var V = 0; V < C["real_player_count"]; V++)
                              L.push(null);
                            p["extendinfo"] &&
                              (R = B["Tools"]["strOfLocalization"](2004)),
                              p["detail_rule"] &&
                            ...
                            for (var V = 0; V < C["real_player_count"]; V++)
                              null == L[V] &&
                                (L[V] = {
                                  account: 0,
                                  nickname:
                                    B["Tools"]["strOfLocalization"](2010),
                                  avatar_id: d,
                                  level: {
                                    id: "10101",
                                  },
          ...
          (z["prototype"]["onCreate"] = function () {
            ...
            "chs_t" == GameMgr["client_language"]
              ...
              (this["tab_info4"]["clickHandler"] = Laya["Handler"]["create"](
                ...
                function () {
                  C["locking"] ||
                    (1 != C["tab_index"] && C["changeMJCategory"](1));
                },
                null,
                !1
              )),
              ...
              (this["tab_info3"]["clickHandler"] = Laya["Handler"]["create"](
                ...
                function () {
                  C["locking"] ||
                    (2 != C["tab_index"] && C["changeMJCategory"](2));
                },
                null,
                !1
              )),
                  ...
                  C["locking"] ||
                    ("chs" != GameMgr["client_type"] &&
                      ...
                      (game["Tools"]["during_chat_close"]()
                        ? B["UIMgr"].Inst["ShowErrorInfo"](
                            "功能维护中，祝大家新年快乐"
                          )
                        : C["container_info"]["visible"] &&
                          ((C["container_info"]["visible"] = !1),
                          (C["tab_info4"].skin = C["tab_img_dark"]),
                          (C["tab_info3"].skin = C["tab_img_dark"]),
                          (C["tab_note"].skin = C["tab_img_chosen"]),
                          (C["tab_index"] = 3),
                          C.note.show())));
                },
                null,
          ...
          (z["prototype"].show = function (C, z, e, I, p) {
            ...
            void 0 === z && (z = 1),
              ...
              app["NetAgent"]["sendReq2Lobby"](
                ...
                function (z, e) {
                  z || e["error"]
                    ? B["UIMgr"].Inst["showNetReqError"](
                        "fetchAccountStatisticInfo",
                        z,
                        e
                      )
                    : B["UI_Shilian"]["now_season_info"] &&
                      1001 == B["UI_Shilian"]["now_season_info"]["season_id"] &&
                      3 != B["UI_Shilian"]["get_cur_season_state"]()
                    ? (L["detail_data"]["setData"](e),
                      L["changeMJCategory"](
                        L["tab_index"],
                        L["game_category"],
                        L["game_type"]
              ...
              app["NetAgent"]["sendReq2Lobby"](
                ...
                function (z, e) {
                  if (z || e["error"])
                    ...
                    //end
                    (C["player_data"] = I),
                      C["account_id"] != GameMgr.Inst["account_id"] &&
                        C["show_name"] &&
                        (I["nickname"] = C["show_name"]),
                      ...
                      (C["title"].id = game["Tools"]["titleLocalization"](
                        I["account_id"],
                        I["title"]
                      )),
                      ...
                      C["account_id"] == GameMgr.Inst["account_id"]
                        ? C["illust"]["setSkin"](I["avatar_id"], "waitingroom")
                        : C["illust"]["setSkin"](
                      ...
                      C["account_id"] != GameMgr.Inst["account_id"] &&
                      null == game["FriendMgr"].find(C["account_id"])
                        ? ((C["btn_addfriend"]["visible"] = !0),
                          (C["btn_report"].x = 520))
                        : ((C["btn_addfriend"]["visible"] = !1),
                          (C["btn_report"].x = 343)),
          ...
          (z["prototype"]["close"] = function () {
            ...
            this["enable"] &&
              (this["locking"] ||
                ...
                B["UIBase"]["anim_pop_hide"](
                  this.root,
                  Laya["Handler"]["create"](this, function () {
                    (C["locking"] = !1), (C["enable"] = !1);
                  })
                )));
          }),
      ...
      var C = (function () {
          function C(C, e) {
            ...
            (this["_scale"] = 1),
              ...
              (this["scrollbar"] =
                C["getChildByName"]("scrollbar")["scriptMap"][
                  "capsui.CScrollBar"
                ]),
              this["scrollbar"].init(
              ...
              (this["dongtai_kaiguan"] = new B["UI_Dongtai_Kaiguan"](
          ...
          return (
            ...
            (C["prototype"].move = function (B, C) {
              var z = this["illust"].x + B,
                e = this["illust"].y + C;
              z < this["illust_center_x"] - 600
                ? (z = this["illust_center_x"] - 600)
                : z > this["illust_center_x"] + 600 &&
                  (z = this["illust_center_x"] + 600),
                e < this["illust_center_y"] - 1200
                  ? (e = this["illust_center_y"] - 1200)
                  : e > this["illust_center_y"] + 800 &&
                    (e = this["illust_center_y"] + 800),
                (this["illust"].x = z),
                (this["illust"].y = e);
            }),
        ...
        z = (function (z) {
          ...
          return (
            ...
            (e["onMainSkinChange"] = function () {
              var B = cfg["item_definition"].skin.get(
                GameMgr.Inst["account_data"]["avatar_id"]
              );
              B &&
                B["spine_type"] &&
                CatFoodSpine["SpineMgr"].Inst["changeSpineImportant"](
                  game["Tools"]["localUISrc"](B.path) + "/spine"
                );
            }),
            (e["randomDesktopID"] = function () {
              var C =
                B["UI_Sushe"]["commonViewList"][
                  B["UI_Sushe"]["using_commonview_index"]
                ];
              if (
                ...
                for (var z = 0; z < C["length"]; z++)
                  C[z].slot == game["EView"].mjp
                    ? (this["now_mjp_id"] = C[z].type
                        ? C[z]["item_id_list"][
                            Math["floor"](
                              Math["random"]() * C[z]["item_id_list"]["length"]
                            )
                          ]
                        : C[z]["item_id"])
                    : C[z].slot == game["EView"]["desktop"]
                    ? (this["now_desktop_id"] = C[z].type
                        ? C[z]["item_id_list"][
                            Math["floor"](
                              Math["random"]() * C[z]["item_id_list"]["length"]
                            )
                        ...
                        : C[z]["item_id"])
                    : C[z].slot == game["EView"]["mjp_surface"] &&
                      (this["now_mjp_surface_id"] = C[z].type
                        ? C[z]["item_id_list"][
                            Math["floor"](
                              Math["random"]() * C[z]["item_id_list"]["length"]
                            )
                  ...
                  if (I || p["error"])
                    ...
                    if (
                      ...
                      (z["characters"] = []),
                        ...
                        (z["skin_map"]["400101"] = 1),
                        (z["skin_map"]["400201"] = 1),
                        (z["main_character_id"] = "200001");
                    if (
                      ((z["send_gift_count"] = 0),
                      (z["send_gift_limit"] = 0),
                      p["send_gift_count"] &&
                        (z["send_gift_count"] = p["send_gift_count"]),
                      p["send_gift_limit"] &&
                        (z["send_gift_limit"] = p["send_gift_limit"]),
                      p["finished_endings"])
                    )
                    ...
                    if (
                      ((z["star_chars"] = []),
                      p["character_sort"] &&
                        (z["star_chars"] = p["character_sort"]),
                      (e["hidden_characters_map"] = {}),
                      p["hidden_characters"])
                    )
                      for (
                        var R = 0, E = p["hidden_characters"];
                        R < E["length"];
                        R++
                      ) {
                        var V = E[R];
            ...
            (e["onFetchSuccess"] = function (B) {
              ...
              if (C) {
                ...
                if (
                  ...
                  C["send_gift_count"] &&
                    (this["send_gift_count"] = C["send_gift_count"]),
                  C["send_gift_limit"] &&
                    (this["send_gift_limit"] = C["send_gift_limit"]),
                  C["finished_endings"])
                )
                ...
                if (
                  ((this["star_chars"] = []),
                  C["character_sort"] &&
                    0 != C["character_sort"]["length"] &&
                    (this["star_chars"] = C["character_sort"]),
                  (e["hidden_characters_map"] = {}),
                  C["hidden_characters"])
                )
                  for (
                    var I = 0, p = C["hidden_characters"];
                    I < p["length"];
                    I++
                  ) {
                    var L = p[I];
              ...
              if (C["character"]) {
                ...
                if (z["characters"])
                  for (var e = z["characters"], I = 0; I < e["length"]; I++) {
                    for (
                      var p = !1, L = 0;
                      L < this["characters"]["length"];
                      L++
                    )
                      if (this["characters"][L]["charid"] == e[I]["charid"]) {
                        (this["characters"][L] = e[I]),
                          B["UI_Sushe_Visit"].Inst &&
                            B["UI_Sushe_Visit"].Inst["chara_info"] &&
                            B["UI_Sushe_Visit"].Inst["chara_info"]["charid"] ==
                              this["characters"][L]["charid"] &&
                            (B["UI_Sushe_Visit"].Inst["chara_info"] =
                              this["characters"][L]),
                          (p = !0);
                        break;
            ...
            (e["chara_owned"] = function (B) {
              for (var C = 0; C < this["characters"]["length"]; C++)
                if (this["characters"][C]["charid"] == B) return !0;
              return !1;
            }),
            ...
            Object["defineProperty"](e, "main_chara_info", {
              get: function () {
                for (var B = 0; B < this["characters"]["length"]; B++)
                  if (
                    this["characters"][B]["charid"] == this["main_character_id"]
                  )
            ...
            (e["on_view_remove"] = function (B) {
              for (var C = 0; C < this["commonViewList"]["length"]; C++)
                for (
                  var z = this["commonViewList"][C], e = 0;
                  e < z["length"];
                  e++
                )
                  if (
                    (z[e]["item_id"] == B &&
                      (z[e]["item_id"] = game["GameUtility"][
                        "get_view_default_item_id"
                      ](z[e].slot)),
                    z[e]["item_id_list"])
                  ) {
              ...
              p.type == game["EView"]["head_frame"] &&
                GameMgr.Inst["account_data"]["avatar_frame"] == B &&
            ...
            (e["check_all_char_repoint"] = function () {
              for (var B = 0; B < e["characters"]["length"]; B++)
                if (this["check_char_redpoint"](e["characters"][B])) return !0;
              return !1;
            }),
            (e["check_char_redpoint"] = function (B) {
              ...
              if (C)
                for (var z = 0; z < C["length"]; z++) {
                  ...
                  if (
                    !(
                      (I["is_married"] && !B["is_upgraded"]) ||
                      (!I["is_married"] && B["level"] < I["level_limit"])
                    ) &&
                    2 == I.type
                  ) {
                    for (var p = !0, L = 0; L < I["jieju"]["length"]; L++)
                      if (
                        I["jieju"][L] &&
                        e["finished_endings_map"][I["jieju"][L]]
                      ) {
              ...
              if (R && R.ur)
                for (
                  var E = cfg["level_definition"]["character"]["getGroup"](
                      B["charid"]
                    ),
                    V = 1,
                    d = 0,
            ...
            (e["change_char_star"] = function (B) {
              ...
              -1 != C
                ? this["star_chars"]["splice"](C, 1)
                : this["star_chars"].push(B);
              // 屏蔽网络请求
            ...
            (e["prototype"]["onCreate"] = function () {
              ...
              (this["contianer_illust"] = this.me["getChildByName"]("illust")),
                ...
                (this["illust_rect"] = B["UIRect"]["CreateFromSprite"](
                  this["illust"].me
                )),
                (this["container_chat"] =
                  this["contianer_illust"]["getChildByName"]("chat")),
                (this["chat_block"] = new B["UI_Character_Chat"](
                  this["container_chat"],
                  !0
                )),
                (this["contianer_illust"]["getChildByName"]("btn")[
                  ...
                  function () {
                    if (
                      !z["page_visit_character"].me["visible"] ||
                      !z["page_visit_character"]["cannot_click_say"]
                    )
                      if ((z["illust"]["onClick"](), z["sound_id"]))
                        z["stopsay"]();
                      else {
                        if (!z["illust_showing"]) return;
                        z.say("lobby_normal");
                      }
                  },
                  null,
                ...
                (this["container_look_illust"] = new C(
            ...
            (e["prototype"].show = function (C) {
              ...
              0 == C
                ? (this["change_select"](z), this["show_page_select"]())
                : ((this["_select_index"] = -1),
            ...
            (e["prototype"]["starup_back"] = function () {
              (this["enable"] = !0),
                ...
                this["page_visit_character"]["star_up_back"](
                  e["characters"][this["_select_index"]]
                ),
              ...
              if (!this["illust_showing"])
                if (((this["illust_showing"] = !0), this["_select_index"] >= 0))
                  ...
                  for (var C = 0, z = 0; z < e["characters"]["length"]; z++)
                    if (
                      e["characters"][z]["charid"] == e["main_character_id"]
                    ) {
                      C = z;
                      break;
                    }
              ...
              if (
                ("chs" == GameMgr["client_language"] &&
                  ((this["label_name"].font =
                    -1 != e["chs_fengyu_name_lst"]["indexOf"](z["charid"])
                      ? "fengyu"
                      : "hanyi"),
                  (this["label_cv"].font =
                    -1 != e["chs_fengyu_cv_lst"]["indexOf"](z["charid"])
                      ? "fengyu"
                      : "hanyi")),
                "chs" == GameMgr["client_language"] ||
                  "chs_t" == GameMgr["client_language"])
              ) {
                (this["label_name"].text = I[
                ...
                p.test(I["name_" + GameMgr["client_language"]]) &&
            ...
            (e["prototype"]["onChangeSkin"] = function (B) {
              (e["characters"][this["_select_index"]].skin = B),
                this["change_select"](this["_select_index"]),
                e["characters"][this["_select_index"]]["charid"] ==
                  e["main_character_id"] &&
                  ((GameMgr.Inst["account_data"]["avatar_id"] = B),
                  e["onMainSkinChange"]());
            ...
            (e["prototype"]["jump_to_char_skin"] = function (C, z) {
              var I = this;
              if (
                (void 0 === C && (C = -1), void 0 === z && (z = null), C >= 0)
              )
            ...
            (this["scrollview"] = null),
              ...
              (this.me["getChildByName"]("btn_huanzhuang")["clickHandler"] =
                Laya["Handler"]["create"](
                  ...
                  function () {
                    z.Inst["locking"] ||
                      B["UI_Sushe"].Inst["jump_to_char_skin"]();
                  },
                  null,
                  !1
                )),
          ...
          return (
            ...
            (C["prototype"]["render_character_cell"] = function (C) {
              ...
              (I["visible"] = !0),
                ...
                p["inited"] ||
                  ((p["inited"] = !0),
                  (I["getChildByName"]("btn")["clickHandler"] = new Laya[
                    "Handler"
                  ](this, function () {
                    z["onClickAtHead"](p["index"]);
                  })),
                  (p.skin = new B["UI_Character_Skin"](
                    I["getChildByName"]("btn")["getChildByName"]("head")
                  )),
                  (p.bg = I["getChildByName"]("btn")["getChildByName"]("bg")),
                  (p["bound"] =
                    I["getChildByName"]("btn")["getChildByName"]("bound")),
                  (p["btn_star"] = I["getChildByName"]("btn_star")),
                  (p.star =
                    I["getChildByName"]("btn")["getChildByName"]("star")),
              ...
              L["getChildByName"]("choose")["visible"] =
                e == this["select_index"];
              var R = this["getCharInfoByIndex"](e);
              (L["getChildByName"]("redpoint")["visible"] =
                B["UI_Sushe"]["check_char_redpoint"](R)),
                p.skin["setSkin"](R.skin, "bighead"),
                (L["getChildByName"]("using")["visible"] =
                  R["charid"] == B["UI_Sushe"]["main_character_id"]),
                (I["getChildByName"]("btn")["getChildByName"]("bg").skin = game[
                  "Tools"
                ]["localUISrc"](
                  "myres/sushe/bg_head" + (R["is_upgraded"] ? "2.png" : ".png")
                ));
              ...
              "kr" == GameMgr["client_language"]
                ? (p["bound"].skin = E.ur
                    ? game["Tools"]["localUISrc"](
                        "myres/sushe/bg_head_bound" +
                          (R["is_upgraded"] ? "4.png" : "3.png")
                      )
                    : game["Tools"]["localUISrc"](
                        "myres/sushe/en_head_bound" +
                          (R["is_upgraded"] ? "2.png" : ".png")
                      ))
                : E.ur
                ? (p["bound"].pos(-10, -2),
                  (p["bound"].skin = game["Tools"]["localUISrc"](
                    "myres/sushe/bg_head" +
                      (R["is_upgraded"] ? "6.png" : "5.png")
                  )))
                : (p["bound"].pos(4, 20),
                  (p["bound"].skin = game["Tools"]["localUISrc"](
                    "myres/sushe/bg_head" +
                ...
                (p.star["visible"] =
                  B["UI_Sushe"]["is_char_star"](R["charid"]) ||
                  this["select_index"] == e);
              var V = cfg["item_definition"]["character"].find(R["charid"]),
                d = L["getChildByName"]("label_name"),
                f = V["name_" + GameMgr["client_language"] + "2"]
                  ? V["name_" + GameMgr["client_language"] + "2"]
                  : V["name_" + GameMgr["client_language"]];
              if (
                "chs" == GameMgr["client_language"] ||
                "chs_t" == GameMgr["client_language"]
              ) {
                (p.star.skin = game["Tools"]["localUISrc"](
                  "myres/sushe/tag_star_" +
                    (B["UI_Sushe"]["is_char_star"](R["charid"]) ? "l" : "d") +
                    (R["is_upgraded"] ? "1.png" : ".png")
                )),
              ...
              ("chs" == GameMgr["client_language"] ||
                "chs_t" == GameMgr["client_language"]) &&
                ("200041" == R["charid"]
                  ? ((d["scaleX"] = 0.67), (d["scaleY"] = 0.57))
                  : ((d["scaleX"] = 0.7), (d["scaleY"] = 0.6)));
            }),
              ...
              if (!this["locking"])
                if (this["select_index"] == C) {
                  ...
                  if (e["charid"] != B["UI_Sushe"]["main_character_id"])
                    if (B["UI_PiPeiYuYue"].Inst["enable"])
                      ...
                      for (
                        ...
                        this["getCharInfoByIndex"](p)["charid"] == I &&
                  ...
                  (this["select_index"] = C),
                    ...
                    this["scrollview"]["wantToRefreshItem"](C),
                    B["UI_Sushe"].Inst["change_select"](
                      this["show_index_list"][C]
                    );
                }
            }),
            (C["prototype"]["onClickAtStar"] = function (C) {
              if (
                (B["UI_Sushe"]["change_char_star"](
                  this["getCharInfoByIndex"](C)["charid"]
                ),
            ...
            (C["prototype"]["onChangeStarShowBtnClick"] = function () {
              if (!this["only_show_star_char"]) {
                for (
                  var C = !1, z = 0, e = B["UI_Sushe"]["star_chars"];
                  z < e["length"];
                  z++
                ) {
                  var I = e[z];
            ...
            (C["prototype"]["getShowStarState"] = function () {
              ...
              if (
                ...
                for (
                  var C = 0, z = B["UI_Sushe"]["star_chars"];
                  C < z["length"];
                  C++
                ) {
                  var e = z[C];
                  if (!B["UI_Sushe"]["hidden_characters_map"][e]) return;
                }
                (this["only_show_star_char"] = !1),
                  app["PlayerBehaviorStatistic"]["update_val"](
                    app["EBehaviorType"]["Chara_Show_Star"],
            ...
            (C["prototype"]["sortShowCharsList"] = function () {
              ...
              for (
                ...
                if (!B["UI_Sushe"]["hidden_characters_map"][e])
                  for (
                    var I = 0;
                    I < B["UI_Sushe"]["characters"]["length"];
                    I++
                  )
                    if (B["UI_Sushe"]["characters"][I]["charid"] == e) {
                      I == B["UI_Sushe"].Inst["select_index"] &&
                        (this["select_index"] =
                          this["show_index_list"]["length"]),
              ...
              if (!this["only_show_star_char"])
                for (var I = 0; I < B["UI_Sushe"]["characters"]["length"]; I++)
                  B["UI_Sushe"]["hidden_characters_map"][
                    B["UI_Sushe"]["characters"][I]["charid"]
                  ] ||
                    (-1 == this["show_index_list"]["indexOf"](I) &&
                      (I == B["UI_Sushe"].Inst["select_index"] &&
                        (this["select_index"] =
                          this["show_index_list"]["length"]),
                      this["show_index_list"].push(I)));
        ...
        z = (function (z) {
          ...
          return (
            ...
            (e["prototype"]["onCreate"] = function () {
              ...
              (this["container_top"] = this.me["getChildByName"]("top")),
                (this["container_top"]["getChildByName"]("btn_back")[
                  ...
                  function () {
                    z["locking"] ||
                      (1 == z["tab_index"] &&
                      z["container_zhuangban"]["changed"]
                        ? B["UI_SecondConfirm"].Inst.show(
                            game["Tools"]["strOfLocalization"](3022),
                            Laya["Handler"]["create"](z, function () {
                              z["close"](), B["UI_Sushe"].Inst["go2Lobby"]();
                            }),
                            null
                          )
                        : (z["close"](), B["UI_Sushe"].Inst["go2Lobby"]()));
              ...
              for (
                var e = this.root["getChildByName"]("container_tabs"),
                  I = function (C) {
                    p.tabs.push(e["getChildAt"](C)),
                      (p.tabs[C]["clickHandler"] = new Laya["Handler"](
                        p,
                        function () {
                          z["locking"] ||
                            (z["tab_index"] != C &&
                ...
                I(L);
              (this["container_head"] = new C(
                this.root["getChildByName"]("container_heads")
              )),
                (this["container_zhuangban"] = new B["zhuangban"][
                  "Container_Zhuangban"
                ](
            ...
            (e["prototype"].show = function (C) {
              ...
              for (var e = 0; e < this.tabs["length"]; e++) {
                ...
                (p["color"] = e == this["tab_index"] ? "#552c1c" : "#d3a86c"),
                  (p["scaleX"] = p["scaleY"] =
                    e == this["tab_index"] ? 1.1 : 1),
                  e == this["tab_index"] &&
                    I["parent"]["setChildIndex"](I, this.tabs["length"] - 1);
              }
            }),
              ...
              for (var C = 0; C < B["UI_Sushe"]["characters"]["length"]; C++) {
                ...
                e &&
                  Laya["loader"]["clearTextureRes"](
                    game["LoadMgr"]["getResImageSkin"](e.path + "/bighead.png")
                  );
              }
            }),
      ...
      var C = (function () {
          ...
          return (
            (C["prototype"].show = function () {
              ...
              (this["locking"] = !0),
                ...
                (this["sortlist"] = []);
              for (
                var z = game["FriendMgr"]["friend_list"], e = 0;
                e < z["length"];
                e++
              )
              ...
              this["sortlist"] = this["sortlist"].sort(function (B, C) {
                ...
                if (e["state"]["is_online"]) {
                  ...
                  (I += "" != p ? 30000000000 : 60000000000),
                    e.base["level"] &&
                      (I += (e.base["level"].id % 1000) * 10000000),
                    e.base["level3"] &&
                      (I += (e.base["level3"].id % 1000) * 10000),
                    (I += -Math["floor"](e["state"]["login_time"] / 10000000));
                } else I += e["state"]["logout_time"];
                var L = z[C],
                  R = 0;
                if (L["state"]["is_online"]) {
                  ...
                  (R += "" != p ? 30000000000 : 60000000000),
                    L.base["level"] &&
                      (R += (L.base["level"].id % 1000) * 10000000),
                    L.base["level3"] &&
                      (R += (L.base["level3"].id % 1000) * 10000),
                    (R += -Math["floor"](L["state"]["login_time"] / 10000000));
                } else R += L["state"]["logout_time"];
                return R - I;
              });
              for (var e = 0; e < z["length"]; e++)
                this["friends"].push({
            ...
            (C["prototype"]["render_item"] = function (C) {
              var z = C["index"],
                ...
                p = C["cache_data"];
              p.head ||
                ((p.head = new B["UI_Head"](
                  e["getChildByName"]("head"),
                  "UI_WaitingRoom"
                )),
                (p.name = e["getChildByName"]("name")),
                (p["state"] = e["getChildByName"]("label_state")),
                (p.btn = e["getChildByName"]("btn_invite")),
                (p["invited"] = e["getChildByName"]("invited")));
              ...
              if (L.f["state"]["is_online"]) {
                var E = game["Tools"]["playState2Desc"](
                  L.f["state"]["playing"]
                );
                "" != E
              ...
              L["invited"]
                ...
                : ((p.btn["visible"] = !0),
                  (p["invited"]["visible"] = !1),
                  game["Tools"]["setGrayDisable"](p.btn, !R),
                  R &&
        ...
        z = (function () {
          function C(C) {
            ...
            (this.tabs = []),
              ...
              (this.root = this.me["getChildByName"]("root")),
              (this["page_head"] = new B["zhuangban"]["Page_Waiting_Head"](
                this.root["getChildByName"]("container_heads")
              )),
              (this["page_zhangban"] = new B["zhuangban"][
                "Container_Zhuangban"
              ](
                this.root["getChildByName"]("container_zhuangban0"),
                this.root["getChildByName"]("container_zhuangban1"),
            ...
            (this.root["getChildByName"]("close")["clickHandler"] = new Laya[
              ...
              z["locking"] ||
                (1 == z["tab_index"] && z["page_zhangban"]["changed"]
                  ? B["UI_SecondConfirm"].Inst.show(
                      game["Tools"]["strOfLocalization"](3022),
                      Laya["Handler"]["create"](z, function () {
                        z["close"](!1);
          ...
          return (
            (C["prototype"].show = function () {
              ...
              for (var z = 0; z < this.tabs["length"]; z++) {
                ...
                (I["color"] = z == this["tab_index"] ? "#552c1c" : "#d3a86c"),
                  ...
                  z == this["tab_index"] &&
                    e["parent"]["setChildIndex"](e, this.tabs["length"] - 1);
              }
            }),
            ...
            (C["prototype"]["close"] = function (C) {
              ...
              if (
                !(
                  z.page_head.choosed_chara_index == 0 &&
                  z.page_head.choosed_skin_id == 0
                )
              ) {
                for (
                  let id = 0;
                  ...
                  if (
                    ...
                    GameMgr.Inst.account_data.avatar_id =
                      z.page_head.choosed_skin_id;
                    uiscript.UI_Sushe.main_character_id =
                      z.page_head.choosed_chara_index + 200001;
                    uiscript.UI_WaitingRoom.Inst._refreshPlayerInfo(
                      uiscript.UI_WaitingRoom.Inst.players[id]
                    );
                    MMP.settings.characters[z.page_head.choosed_chara_index] =
                      z.page_head.choosed_skin_id;
                    MMP.saveSettings();
                    break;
                  }
              ...
              this.me["visible"] &&
                (C
                  ...
                  : (app["NetAgent"]["sendReq2Lobby"](
                      ...
                      {
                        ready:
                          I.Inst["owner_id"] == GameMgr.Inst["account_id"]
                            ? !0
                            : !1,
                        dressing: !1,
                      },
        ...
        e = (function () {
          ...
          return (
            (B["prototype"].show = function (B) {
              ...
              C > 380
                ? ((this["scrollview"]["_content"].y = 10),
                  (this.bg["height"] = 400))
                : ((this["scrollview"]["_content"].y = 390 - C),
                  (this.bg["height"] = C + 20)),
                (this.bg["visible"] = !0);
            }),
            (B["prototype"]["render_item"] = function (B) {
              ...
              (e["fontSize"] = 40),
                (e["fontSize"] =
                  this["modes"][C]["length"] <= 5
                    ? 40
                    : this["modes"][C]["length"] <= 9
                    ? 55 - 3 * this["modes"][C]["length"]
                    : 28),
                (e.text = this["modes"][C]);
            }),
            B
        ...
        I = (function (I) {
          function p() {
            ...
            return (
              (C["skin_ready"] = "myres/room/btn_ready.png"),
              ...
              app["NetAgent"]["AddListener2Lobby"](
                ...
                Laya["Handler"]["create"](C, function (B) {
              ...
              app["NetAgent"]["AddListener2Lobby"](
                ...
                Laya["Handler"]["create"](C, function (B) {
                  C["enable"] &&
                    (app.Log.log("NotifyRoomGameStart:" + JSON["stringify"](B)),
          ...
          return (
            ...
            (p["prototype"]["push_msg"] = function (B) {
              this["pre_msgs"]["length"] < 15
                ? this["pre_msgs"].push(JSON["parse"](B))
                : ((this["msg_tail"] =
                    (this["msg_tail"] + 1) % this["pre_msgs"]["length"]),
                  (this["pre_msgs"][this["msg_tail"]] = JSON["parse"](B)));
            }),
            ...
            (p["prototype"]["updateData"] = function (B) {
              if (!B) return this["resetData"](), void 0;
              //修改友人房间立绘
              for (let i = 0; i < B.persons.length; i++) {
                if (
                  B.persons[i].account_id ==
                  GameMgr.Inst.account_data.account_id
                ) {
                  B.persons[i].avatar_frame =
                    GameMgr.Inst.account_data.avatar_frame;
              ...
              (this["room_id"] = B["room_id"]),
                ...
                B["tournament_id"] &&
                  (this["tournament_id"] = B["tournament_id"]),
              ...
              (this["update_seq"] = 0), B.seq && (this["update_seq"] = B.seq);
            }),
            ...
            (p["prototype"]["onPlayerChange"] = function (B) {
              if (
                (app.Log.log(B),
                (B = B["toJSON"]()),
                !(B.seq && B.seq <= this["update_seq"]))
              ) {
                // 修改友人房间立绘
                for (var i = 0; i < B.player_list.length; i++) {
                  if (
                    B.player_list[i].account_id ==
                    GameMgr.Inst.account_data.account_id
                  ) {
                    B.player_list[i].avatar_frame =
                      GameMgr.Inst.account_data.avatar_frame;
                    B.player_list[i].avatar_id =
                      GameMgr.Inst.account_data.avatar_id;
                ...
                if (B.update_list != undefined) {
                  for (var i = 0; i < B.update_list.length; i++) {
                    if (
                      B.update_list[i].account_id ==
                      GameMgr.Inst.account_data.account_id
                    ) {
                      B.update_list[i].avatar_frame =
                        GameMgr.Inst.account_data.avatar_frame;
                      B.update_list[i].avatar_id =
                        GameMgr.Inst.account_data.avatar_id;
                ...
                if (e < this["robot_count"]) {
                  this["pre_choose"] &&
                    ...
                    z--);
                  for (var I = 0; I < this["players"]["length"]; I++)
                    2 == this["players"][I]["category"] &&
                      z > e &&
                      ((this["players"][I]["category"] = 0), z--);
                }
                for (
                  var p = [], L = B["player_list"], I = 0;
                  ...
                  if (1 == this["players"][I]["category"]) {
                    for (var R = -1, E = 0; E < L["length"]; E++)
                      if (
                        L[E]["account_id"] == this["players"][I]["account_id"]
                      ) {
                        R = E;
                        break;
                      }
                ...
                for (var I = 0; I < L["length"]; I++) {
                  for (
                    ...
                    if (
                      1 == this["players"][E]["category"] &&
                      this["players"][E]["account_id"] == V["account_id"]
                    ) {
                      d = !0;
                      break;
                    }
                ...
                for (
                  ...
                  -1 != this["players"][I]["cell_index"] &&
                    ((f[this["players"][I]["cell_index"]] = !0),
                    this["_refreshPlayerInfo"](this["players"][I]));
                for (var I = 0; I < this["players"]["length"]; I++)
                  if (
                    1 == this["players"][I]["category"] &&
                    -1 == this["players"][I]["cell_index"]
                  )
                ...
                for (
                  var z = this["robot_count"], e = B["robot_count"];
                  e > z;
            ...
            (p["prototype"]["onCreate"] = function () {
              ...
              for (
                var L = function (C) {
                    ...
                    (e["index"] = C),
                      ...
                      (e["container_name"] =
                        z["getChildByName"]("container_name")),
                      (e.name =
                        z["getChildByName"]("container_name")["getChildByName"](
                          "name"
                        )),
                      (e["btn_t"] = z["getChildByName"]("btn_t")),
                      (e["container_illust"] =
                        z["getChildByName"]("container_illust")),
                      (e["illust"] = new B["UI_Character_Skin"](
                        z["getChildByName"]("container_illust")[
                          "getChildByName"
                        ]("illust")
                      )),
                      (e.host = z["getChildByName"]("host")),
                      (e["title"] = new B["UI_PlayerTitle"](
                        z["getChildByName"]("container_name")["getChildByName"](
                          "title"
                        ),
                        "UI_WaitingRoom"
                      )),
                      (e.rank = new B["UI_Level"](
                        z["getChildByName"]("container_name")["getChildByName"](
                          "rank"
                        ),
                        "UI_WaitingRoom"
                      ...
                      (e["is_robot"] = !1);
                    var L = 0;
                    (e["btn_t"]["clickHandler"] = Laya["Handler"]["create"](
                      R,
                      function () {
                      ...
                      (e["btn_info"]["clickHandler"] = Laya["Handler"][
                        "create"
                      ](
                        R,
                        function () {
                          if (!I["locking"])
                            for (var z = 0; z < I["players"]["length"]; z++)
                              if (I["players"][z]["cell_index"] == C) {
                                I["players"][z]["account_id"] &&
                                  I["players"][z]["account_id"] > 0 &&
                                  B["UI_OtherPlayerInfo"].Inst.show(
                                    I["players"][z]["account_id"],
              ...
              (this["container_top"]["getChildByName"]("btn_leave")[
                ...
                this,
                function () {
                  Laya["timer"]["currTimer"] < d + 500 ||
                    ((d = Laya["timer"]["currTimer"]), I["leaveRoom"]());
                },
                null,
                !1
              )),
              ...
              (this["btn_add_robot"]["clickHandler"] = Laya["Handler"][
                ...
                (this["container_right"]["getChildByName"]("btn_help")[
                  ...
                  function () {
                    if (!I["locking"]) {
                      var C = 0;
                      I["room_mode"]["detail_rule"] &&
                        I["room_mode"]["detail_rule"]["chuanma"] &&
                        (C = 1),
                ...
                (this["btn_copy"]["clickHandler"] = Laya["Handler"]["create"](
                  ...
                  function () {
                    I["popout"]["visible"] ||
                      ...
                      (I["popout"]["visible"] = !0),
                      B["UIBase"]["anim_pop_out"](I["popout"], null));
                  },
                  null,
                  !1
                )),
                (this["container_rules"] = new e(
                ...
                this["room_link"].on("focus", this, function () {
                  I["room_link"]["focus"] &&
                    I["room_link"]["setSelection"](
                      0,
                      I["room_link"].text["length"]
                    );
                }),
                (this["btn_copy_link"] =
                ...
                GameMgr["inConch"]
                  ? ((this["btn_copy_link"]["visible"] = !0),
                    (this["btn_copy_link"]["clickHandler"] = Laya["Handler"][
                      ...
                      this,
                      function () {
                        var C = Laya["PlatformClass"]["createClass"](
              ...
              (this["popout"]["getChildByName"]("blackbg")["clickHandler"] = A),
                ...
                (this["invitefriend"] = new C(
                  this.me["getChildByName"]("invite_friend")
                )),
                (this["pop_change_view"] = new z(
            ...
            (p["prototype"].show = function () {
              ...
              for (var z = 0; 4 > z; z++)
                this["player_cells"][z]["container"]["visible"] =
                  z < this["max_player_count"];
              for (var z = 0; z < this["max_player_count"]; z++)
                this["_clearCell"](z);
              for (var z = 0; z < this["players"]["length"]; z++)
                (this["players"][z]["cell_index"] = z),
              ...
              if (p) {
                var L = 5,
                  R = 20;
                if (
                  (null != p["time_fixed"] && (L = p["time_fixed"]),
                  null != p["time_add"] && (R = p["time_add"]),
                  I.push(
                    L["toString"]() +
                      "+" +
                      R["toString"]() +
                  ...
                  var E = cfg["tournament"]["tournaments"].get(
                    this["tournament_id"]
                  );
                  E && I.push(E.name);
                }
                if (
                  ...
                  p["guyi_mode"] &&
                    I.push(game["Tools"]["strOfLocalization"](3028)),
                  null != p["dora_count"])
                )
                  switch (
                ...
                null != p["shiduan"] &&
                  ...
                  2 === p["fanfu"] &&
                    I.push(game["Tools"]["strOfLocalization"](2763)),
                  4 === p["fanfu"] &&
                    I.push(game["Tools"]["strOfLocalization"](2764)),
                  null != p["bianjietishi"] &&
                    1 != p["bianjietishi"] &&
            ...
            (p["prototype"]["leaveRoom"] = function () {
              ...
              this["locking"] ||
                app["NetAgent"]["sendReq2Lobby"](
                  ...
                  function (z, e) {
                    z || e["error"]
                      ? B["UIMgr"].Inst["showNetReqError"]("leaveRoom", z, e)
                      : ((C["room_id"] = -1),
                        C.hide(
                          Laya["Handler"]["create"](C, function () {
                            B["UI_Lobby"].Inst["enable"] = !0;
            ...
            (p["prototype"]["tryToClose"] = function (C) {
              ...
              app["NetAgent"]["sendReq2Lobby"](
                ...
                function (e, I) {
                  e || I["error"]
                    ? (B["UIMgr"].Inst["showNetReqError"]("leaveRoom", e, I),
                      C["runWith"](!1))
                    : ((z["enable"] = !1),
                      z["pop_change_view"]["close"](!0),
                      C["runWith"](!0));
                }
              );
            }),
            ...
            (p["prototype"]["onDisbale"] = function () {
              ...
              for (var B = 0; B < this["player_cells"]["length"]; B++)
                Laya["loader"]["clearTextureRes"](
                  this["player_cells"][B]["illust"].skin
                );
              document["getElementById"]("layaCanvas")["onclick"] = null;
            }),
              ...
              this["owner_id"] == GameMgr.Inst["account_id"] &&
                (Laya["timer"]["currTimer"] < this["last_start_room"] + 2000 ||
                  ...
                  app["NetAgent"]["sendReq2Lobby"](
                    ...
                    function (C, z) {
                      (C || z["error"]) &&
                        B["UIMgr"].Inst["showNetReqError"]("startRoom", C, z);
                    }
                  )));
            }),
            ...
            (p["prototype"]["_refreshPlayerInfo"] = function (B) {
              ...
              if (!(0 > C || C >= this["player_cells"]["length"])) {
                ...
                (z["container_illust"]["visible"] = !0),
                  ...
                  (z["btn_t"]["visible"] =
                    this["owner_id"] == GameMgr.Inst["account_id"] &&
                    B["account_id"] != GameMgr.Inst["account_id"]),
                  this["owner_id"] == B["account_id"] &&
                    ((z["container_flag"]["visible"] = !0),
                    (z.host["visible"] = !0)),
                  B["account_id"] == GameMgr.Inst["account_id"]
                    ? z["illust"]["setSkin"](B["avatar_id"], "waitingroom")
                    : z["illust"]["setSkin"](
                        game["GameUtility"]["get_limited_skin_id"](
                          B["avatar_id"]
                        ),
                  ...
                  (z["title"].id = game["Tools"]["titleLocalization"](
                    B["account_id"],
                    B["title"]
                  )),
                  (z.rank.id =
                    B[this["room_mode"].mode < 10 ? "level" : "level3"].id),
            ...
            (p["prototype"]["_onPlayerReadyChange"] = function (B) {
              ...
              if (!(0 > C || C >= this["player_cells"]["length"])) {
                var z = this["player_cells"][C];
                z["container_flag"]["visible"] =
                  this["owner_id"] == B["account_id"] ? !0 : B["ready"];
              }
            }),
            (p["prototype"]["refreshAsOwner"] = function () {
              if (this["owner_id"] == GameMgr.Inst["account_id"]) {
                for (var B = 0, C = 0; C < this["players"]["length"]; C++)
                  0 != this["players"][C]["category"] &&
                    (this["_refreshPlayerInfo"](this["players"][C]), B++);
                (this["btn_add_robot"]["visible"] = !0),
                  (this["btn_invite_friend"]["visible"] = !0),
                  game["Tools"]["setGrayDisable"](
                    this["btn_invite_friend"],
                    B == this["max_player_count"]
                  ),
                  game["Tools"]["setGrayDisable"](
                    this["btn_add_robot"],
                    B == this["max_player_count"]
              ...
              if (this["owner_id"] == GameMgr.Inst["account_id"]) {
                ...
                if (
                  ...
                  if (B != e && !this["posted"]) {
                    this["posted"] = !0;
                    var p = {};
                    (p["okcount"] = B), (p["okcount2"] = e), (p.msgs = []);
                    var L = 0,
    ...
    !(function (B) {
      ...
      !(function (C) {
        var z = (function () {
            ...
            (this["page_items"] = new C["Page_Items"](
              ...
              (this["btn_save"]["clickHandler"] = new Laya["Handler"](
                ...
                function () {
                  for (var C = [], z = 0; z < p["cell_titles"]["length"]; z++) {
                    ...
                    if (p["slot_map"][e]) {
                      ...
                      if (
                        !(
                          (I["item_id"] &&
                            I["item_id"] != p["cell_default_item"][z]) ||
                          (I["item_id_list"] &&
                            0 != I["item_id_list"]["length"])
                        )
                      )
                        continue;
                      var L = [];
                      if (I["item_id_list"])
                        for (
                          var R = 0, E = I["item_id_list"];
                          R < E["length"];
                          R++
                        ) {
                          var V = E[R];
                          V == p["cell_default_item"][z]
                            ? L.push(0)
                            : L.push(V);
                        }
                      C.push({
                  ...
                  if (B["UI_Sushe"]["commonViewList"]["length"] < d)
                    for (
                      var I = B["UI_Sushe"]["commonViewList"]["length"];
                      d >= I;
                      I++
                    )
                  ...
                  //END
                  if (
                    ((B["UI_Sushe"]["commonViewList"][d] = C),
                    B["UI_Sushe"]["using_commonview_index"] == d &&
                      p["onChangeGameView"](),
                    p["tab_index"] != d)
                  )
                    return;
              ...
              (this["btn_use"]["clickHandler"] = new Laya["Handler"](
                ...
                function () {
                  ...
                  (B["UI_Sushe"]["using_commonview_index"] = C),
                    p["refresh_btn"](),
                    p["refresh_tab"](),
                    p["onChangeGameView"](); //);
                  //});
          ...
          return (
            Object["defineProperty"](z["prototype"], "locking", {
              get: function () {
            ...
            (z["prototype"]["change_tab"] = function (C) {
              if (
                ...
                if (
                  this["tab_index"] < B["UI_Sushe"]["commonViewList"]["length"]
                )
                  for (
                    var z = B["UI_Sushe"]["commonViewList"][this["tab_index"]],
                      e = 0;
                    e < z["length"];
                    e++
                  )
            ...
            (z["prototype"]["refresh_tab"] = function () {
              for (var C = 0; C < this.tabs["length"]; C++) {
                ...
                (z["mouseEnabled"] = this["tab_index"] != C),
                  (z["getChildByName"]("bg").skin = game["Tools"]["localUISrc"](
                    this["tab_index"] == C
                      ? "myres/sushe/tab_choosed.png"
                      : "myres/sushe/tab_unchoose.png"
                  )),
                  (z["getChildByName"]("num")["color"] =
                    this["tab_index"] == C ? "#2f1e19" : "#f2c797");
                var e = z["getChildByName"]("choosed");
                B["UI_Sushe"]["using_commonview_index"] == C
                  ? ((e["visible"] = !0),
                    (e.x = this["tab_index"] == C ? -18 : -4))
                  : (e["visible"] = !1);
              }
            }),
            ...
            (z["prototype"]["onChangeSlotSelect"] = function (B) {
              ...
              var z = 0;
              B >= 0 &&
                B < this["cell_default_item"]["length"] &&
                (z = this["cell_default_item"][B]);
              var e = z,
                I = this["slot_ids"][B],
                p = !1,
                L = [];
              if (this["slot_map"][I]) {
                ...
                (L = R["item_id_list"]),
                  ...
                  p &&
                    R["item_id_list"] &&
                    R["item_id_list"]["length"] > 0 &&
                    (e = R["item_id_list"][0]);
              }
              var E = Laya["Handler"]["create"](
                this,
                function (e) {
                  e == z && (e = 0);
                  var p = !1;
                  if (C["is_random"]) {
                    ...
                    L >= 0
                      ? (C["slot_map"][I]["item_id_list"]["splice"](L, 1),
                        (p = !0))
                      : ((C["slot_map"][I]["item_id_list"] &&
                          0 != C["slot_map"][I]["item_id_list"]["length"]) ||
                          (C["slot_map"][I]["item_id_list"] = []),
                        C["slot_map"][I]["item_id_list"].push(e));
                  } else
                    C["slot_map"][I] || (C["slot_map"][I] = {}),
                      (C["slot_map"][I]["item_id"] = e);
                  return (
                    C["scrollview"]["wantToRefreshItem"](B),
                    (C["_changed"] = !0),
                    C["refresh_btn"](),
                    p
                  );
              ...
              this["page_items"]["close"](),
                ...
                (this["random"]["getChildAt"](2)["visible"] =
                  this["is_random"]);
              var V = game["Tools"]["strOfLocalization"](
                this["cell_titles"][B]
              );
              if (B >= 0 && 2 >= B)
                this["page_items"].show(V, B, e, E),
                  this["setRandomGray"](!this["page_items"]["can_random"]());
              else if (3 == B)
                this["page_items"].show(V, 10, e, E),
                  this["setRandomGray"](!this["page_items"]["can_random"]());
              else if (4 == B)
                this["page_items"].show(V, 3, e, E),
                  this["setRandomGray"](!this["page_items"]["can_random"]());
              else if (5 == B)
                this["page_bgm"].show(V, e, E),
                  this["setRandomGray"](!this["page_bgm"]["can_random"]());
              else if (6 == B) this["page_headframe"].show(V, e, E);
              else if (7 == B || 8 == B) {
                ...
                if (7 == B) {
                  if (((d = e), this["slot_map"][game["EView"].mjp])) {
                    ...
                    A.type &&
                    A["item_id_list"] &&
                    A["item_id_list"]["length"] > 0
                      ? (f = A["item_id_list"][0])
                      : A["item_id"] && (f = A["item_id"]);
                  }
                ...
                if (((f = e), this["slot_map"][game["EView"]["desktop"]])) {
                  var A = this["slot_map"][game["EView"]["desktop"]];
                  A.type && A["item_id_list"] && A["item_id_list"]["length"] > 0
                    ? (d = A["item_id_list"][0])
                    : A["item_id"] && (d = A["item_id"]);
                }
                this["page_desktop"]["show_mjp_surface"](V, d, f, E),
                  this["setRandomGray"](!this["page_desktop"]["can_random"]());
              } else 10 == B && this["page_desktop"]["show_lobby_bg"](V, e, E);
            }),
              ...
              if (6 != this["select_index"] && 10 != this["select_index"]) {
                (this["_changed"] = !0),
                  ...
                  Laya["Tween"].to(
                    ...
                    null,
                    Laya["Handler"]["create"](this, function () {
                      B["random"]["getChildAt"](B["is_random"] ? 1 : 2)[
                        "visible"
                      ] = !1;
                    })
                  );
                var C = this["select_index"],
                  ...
                  e = 0;
                C >= 0 &&
                  C < this["cell_default_item"]["length"] &&
                  (e = this["cell_default_item"][C]);
                var I = e,
                  p = [];
                if (this["slot_map"][z]) {
                ...
                if (C >= 0 && 4 >= C) {
                  ...
                  R
                    ? ((R.type = R.type ? 0 : 1),
                      (R["item_id_list"] && 0 != R["item_id_list"]["length"]) ||
                        (R["item_id_list"] = [R["item_id"]]))
                    : (this["slot_map"][z] = {
                        type: 1,
            ...
            (z["prototype"]["render_view"] = function (B) {
              ...
              this["select_index"] == e
                ? ((I["scaleX"] = I["scaleY"] = 1.05),
                  (I["getChildByName"]("choosed")["visible"] = !0))
                : ((I["scaleX"] = I["scaleY"] = 1),
                  (I["getChildByName"]("choosed")["visible"] = !1)),
                (I["getChildByName"]("title").text = game["Tools"][
                  "strOfLocalization"
                ](this["cell_titles"][e]));
              ...
              if (
                (this["slot_map"][E] &&
                  ((V = this["slot_map"][E].type),
                  this["slot_map"][E]["item_id"] &&
                    (R = this["slot_map"][E]["item_id"])),
                V)
              )
                (p.text = game["Tools"]["strOfLocalization"](3752, [
                  "" + this["slot_map"][E]["item_id_list"]["length"],
                ])),
                ...
                d
                  ? ((p.text = d["name_" + GameMgr["client_language"]]),
                    game["LoadMgr"]["setImgSkin"](
                      L,
                      d.icon,
                      null,
            ...
            (z["prototype"]["onChangeGameView"] = function () {
              ...
              B["UI_Sushe"]["randomDesktopID"](),
                GameMgr.Inst["load_mjp_view"]();
              var C = game["GameUtility"]["get_view_id"](
                game["EView"]["lobby_bg"]
              );
              B["UI_Lite_Loading"].Inst.show(),
                game["Scene_Lobby"].Inst["set_lobby_bg"](
                  C,
                  Laya["Handler"]["create"](this, function () {
                    B["UI_Lite_Loading"].Inst["enable"] &&
                      B["UI_Lite_Loading"].Inst["close"]();
                  })
                ),
                (GameMgr.Inst["account_data"]["avatar_frame"] = game[
                  "GameUtility"
            ...
            (z["prototype"]["setRandomGray"] = function (C) {
              (this["btn_random"]["visible"] = !C),
                (this["random"]["filters"] = C
                  ? [new Laya["ColorFilter"](B["GRAY_FILTER"])]
                  : []);
            }),
      ...
      var C = (function (C) {
        ...
        return (
          ...
          (z["onFetchSuccess"] = function (B) {
            if (
              ((this["owned_title"] = []),
              B["title_list"] && B["title_list"]["title_list"])
            )
              // START
              ...
              for (let title of cfg.item_definition.title.rows_) {
                var z = title.id;
                cfg["item_definition"]["title"].get(z) &&
                  this["owned_title"].push(z),
                  "600005" == z &&
                    app["PlayerBehaviorStatistic"]["fb_trace_pending"](
                      app["EBehaviorType"]["Get_The_Title1"],
                      1
                  ...
                  z >= "600005" &&
                    "600015" >= z &&
                    app["PlayerBehaviorStatistic"]["google_trace_pending"](
                      app["EBehaviorType"]["G_get_title_1"] + z - "600005",
                      1
                    );
              }
          }),
          (z["title_update"] = function (C) {
            for (var z = 0; z < C["new_titles"]["length"]; z++)
              cfg["item_definition"]["title"].get(C["new_titles"][z]) &&
                this["owned_title"].push(C["new_titles"][z]),
                "600005" == C["new_titles"][z] &&
                  app["PlayerBehaviorStatistic"]["fb_trace_pending"](
                    app["EBehaviorType"]["Get_The_Title1"],
                    1
                  ),
                C["new_titles"][z] >= "600005" &&
                  C["new_titles"][z] <= "600015" &&
                  app["PlayerBehaviorStatistic"]["google_trace_pending"](
            ...
            if (C["remove_titles"] && C["remove_titles"]["length"] > 0) {
              for (var z = 0; z < C["remove_titles"]["length"]; z++) {
                for (
                  var e = C["remove_titles"][z], I = 0;
                  I < this["owned_title"]["length"];
                  I++
                )
                ...
                e == GameMgr.Inst["account_data"]["title"] &&
                  ((GameMgr.Inst["account_data"]["title"] = "600001"),
                  B["UI_Lobby"].Inst["enable"] &&
                    B["UI_Lobby"].Inst.top["refresh"](),
                  B["UI_PlayerInfo"].Inst["enable"] &&
                    B["UI_PlayerInfo"].Inst["refreshBaseInfo"]());
              }
          ...
          (z["prototype"]["onCreate"] = function () {
            ...
            (this["_root"] = this.me["getChildByName"]("root")),
              (this["_blackmask"] = new B["UI_BlackMask"](
          ...
          (z["prototype"].show = function () {
            ...
            if (
              ...
              (this["_showindexs"] = this["_showindexs"].sort(function (B, C) {
                ...
                return L && (p += 1000 * L["priority"]), p - e;
              })),
            ...
            if (this["enable"]) {
              ...
              L["clickHandler"] = Laya["Handler"]["create"](
                ...
                function () {
                  I != GameMgr.Inst["account_data"]["title"]
                    ? (e["changeTitle"](B),
                      (C["getChildByName"]("using")["visible"] = !0))
                    : (e["changeTitle"](-1),
                      (C["getChildByName"]("using")["visible"] = !1));
                },
                null,
                !1
              );
              ...
              if (1 == p["unlock_type"]) {
                ...
                (R.text =
                  ...
                  d["expire_desc_" + GameMgr["client_language"]]),
                  (R["visible"] = !0),
                  (E.y = 34);
              } else (R["visible"] = !1), (E.y = 44);
            }
          }),
          (z["prototype"]["changeTitle"] = function (C) {
            var e = this,
              ...
              p = 0;
            (p =
              C >= 0 && C < this["_showindexs"]["length"]
                ? z["owned_title"][this["_showindexs"][C]]
                : "600001"),
        ...
        var z = (function () {
          function z(B) {
            (this["scrollview"] = null),
              ...
              this["scrollview"]["setElastic"](),
              (this["page_skin"] = new C["Page_Skin"](
          ...
          return (
            (z["prototype"].show = function (C) {
              ...
              (this.me["visible"] = !0),
                ...
                (this["chara_infos"] = []);
              for (
                var e = 0, I = B["UI_Sushe"]["star_chars"];
                e < I["length"];
                e++
              )
                for (
                  var p = I[e], L = 0;
                  L < B["UI_Sushe"]["characters"]["length"];
                  L++
                )
                  if (
                    !B["UI_Sushe"]["hidden_characters_map"][p] &&
                    B["UI_Sushe"]["characters"][L]["charid"] == p
                  ) {
                    this["chara_infos"].push({
                      chara_id: B["UI_Sushe"]["characters"][L]["charid"],
                      skin_id: B["UI_Sushe"]["characters"][L].skin,
                      is_upgraded:
                        B["UI_Sushe"]["characters"][L]["is_upgraded"],
                    }),
                      B["UI_Sushe"]["main_character_id"] ==
                        B["UI_Sushe"]["characters"][L]["charid"] &&
              ...
              this["page_skin"].show(
                ...
                Laya["Handler"]["create"](
                  ...
                  function (B) {
                    (z["choosed_skin_id"] = B),
                      (R["skin_id"] = B),
                      z["scrollview"]["wantToRefreshItem"](
                        z["choosed_chara_index"]
                      );
                  },
                  null,
                  !1
            ...
            (z["prototype"]["render_character_cell"] = function (C) {
              ...
              (R["getChildByName"]("choose")["visible"] =
                e == this["choosed_chara_index"]),
                p.skin["setSkin"](L["skin_id"], "bighead"),
                (R["getChildByName"]("using")["visible"] =
                  e == this["choosed_chara_index"]);
              var E = cfg["item_definition"]["character"].find(L["chara_id"]),
                V = E["name_" + GameMgr["client_language"] + "2"]
                  ? E["name_" + GameMgr["client_language"] + "2"]
                  : E["name_" + GameMgr["client_language"]],
              ...
              R["getChildByName"]("star") &&
                (R["getChildByName"]("star")["visible"] =
                  e < this["star_char_count"]);
              ...
              "kr" == GameMgr["client_language"]
                ? (p["bound"].skin = A.ur
                    ? game["Tools"]["localUISrc"](
                        "myres/sushe/bg_head_bound" +
                          (L["is_upgraded"] ? "4.png" : "3.png")
                      )
                    : game["Tools"]["localUISrc"](
                        "myres/sushe/en_head_bound" +
                          (L["is_upgraded"] ? "2.png" : ".png")
                      ))
                : A.ur
                ? (p["bound"].pos(-10, -2),
                  (p["bound"].skin = game["Tools"]["localUISrc"](
                    "myres/sushe/bg_head" +
                      (L["is_upgraded"] ? "6.png" : "5.png")
                  )))
                : (p["bound"].pos(4, 20),
                  (p["bound"].skin = game["Tools"]["localUISrc"](
                    "myres/sushe/bg_head" +
                ...
                (R["getChildByName"]("bg").skin = game["Tools"]["localUISrc"](
                  "myres/sushe/bg_head" + (L["is_upgraded"] ? "2.png" : ".png")
                )),
                (I["getChildByName"]("btn")["clickHandler"] = new Laya[
                  "Handler"
                ](this, function () {
              ...
              if (this.me["visible"])
                if (C) this.me["visible"] = !1;
                  ...
                  for (
                    ...
                    if (
                      B["UI_Sushe"]["characters"][I]["charid"] == e["chara_id"]
                    ) {
                      B["UI_Sushe"]["characters"][I].skin =
                        this["choosed_skin_id"];
                      break;
                    }
                  (GameMgr.Inst["account_data"]["avatar_id"] =
        ...
        function (z, e) {
          if (z || e["error"])
            ...
            for (var I in e["account"]) {
              if (
                ((B.Inst["account_data"][I] = e["account"][I]),
                "platform_diamond" == I)
              )
              ...
              if (
                ("skin_ticket" == I &&
                  (B.Inst["account_numerical_resource"]["100004"] =
                    e["account"][I]),
                "platform_skin_ticket" == I)
              )
                for (var p = e["account"][I], L = 0; L < p["length"]; L++)
                  C["account_numerical_resource"][p[L].id] = p[L]["count"];
            }
            uiscript["UI_Lobby"].Inst["refreshInfo"](),
              ...
              "10102" === B.Inst["account_data"]["level"].id &&
                app["PlayerBehaviorStatistic"]["fb_trace_pending"](
                  app["EBehaviorType"]["Level_2"],
                  1
                ),
              "10103" === B.Inst["account_data"]["level"].id &&
                app["PlayerBehaviorStatistic"]["fb_trace_pending"](
    ...
    GameMgr.Inst.checkPaiPu = function (C, z, e) {
      ...
      return (
        ...
        this["duringPaipu"]
          ...
          : ((this["duringPaipu"] = !0),
            uiscript["UI_Loading"].Inst.show("enter_mj"),
            B.Inst["onLoadStart"]("paipu"),
            2 & e && (C = game["Tools"]["DecodePaipuUUID"](C)),
            (this["record_uuid"] = C),
            app["NetAgent"]["sendReq2Lobby"](
              "Lobby",
              "fetchGameRecord",
              ...
              function (p, L) {
                if (p || L["error"]) {
                  ...
                  Laya["timer"].loop(50, I, E), (I["duringPaipu"] = !1);
                } else {
                  if (MMP.settings.sendGame == true) {
                    GM_xmlhttpRequest({
                      method: "post",
                  ...
                  app["NetAgent"]["sendReq2Lobby"](
                    ...
                    A["extendinfo"] &&
                      (f = game["Tools"]["strOfLocalization"](2004)),
                    A["detail_rule"] &&
                      A["detail_rule"]["ai_level"] &&
                      (1 === A["detail_rule"]["ai_level"] &&
                        (f = game["Tools"]["strOfLocalization"](2003)),
                      2 === A["detail_rule"]["ai_level"] &&
                        (f = game["Tools"]["strOfLocalization"](2004)));
                  var O = !1;
                  V["end_time"]
                    ? ((I["record_end_time"] = V["end_time"]),
                      V["end_time"] > "1576112400" && (O = !0))
                    : (I["record_end_time"] = -1),
                    (I["record_start_time"] = V["start_time"]
                      ? V["start_time"]
                      : -1);
                    ...
                    if (h["character"]) {
                      ...
                      if (MMP.settings.setPaipuChar == true) {
                        if (h.account_id == GameMgr.Inst.account_id) {
                          ...
                          (h.avatar_id == 400101 || h.avatar_id == 400201)
                        ) {
                          // 玩家如果用了默认皮肤也随机换
                          let all_keys = Object.keys(
                            cfg.item_definition.skin.map_
                  ...
                  for (
                    var F = game["GameUtility"]["get_default_ai_skin"](),
                      r = game["GameUtility"]["get_default_ai_character"](),
                      Y = 0;
                    Y < d["length"];
                    Y++
                  )
                        ...
                        game["Scene_MJ"].Inst["openMJRoom"](
                          ...
                          Laya["Handler"]["create"](I, function () {
                            (I["duringPaipu"] = !1),
                              ...
                              view["DesktopMgr"].Inst["initRoom"](
                                JSON["parse"](JSON["stringify"](V["config"])),
                                d,
                                z,
                                view["EMJMode"]["paipu"],
                                Laya["Handler"]["create"](I, function () {
                  ...
                  if (((S["record"] = V), L.data && L.data["length"]))
                    (S.game = net["MessageWrapper"]["decodeMessage"](L.data)),
                      s["runWith"](S);
                  else {
                    var X = L["data_url"];
                      ...
                      game["LoadMgr"]["httpload"](
                        ...
                        Laya["Handler"]["create"](I, function (B) {
                          if (B["success"]) {
                            ...
                            var z = net["MessageWrapper"]["decodeMessage"](
                              C["getUint8Array"](0, C["length"])
                            );
                            (S.game = z), s["runWith"](S);
                          } else uiscript["UIMgr"].Inst["ShowErrorInfo"](game["Tools"]["strOfLocalization"](2005) + L["data_url"]), uiscript["UI_Loading"].Inst["close"](null), uiscript["UIMgr"].Inst["showLobby"](), (I["duringPaipu"] = !1);
                        })
                      );
                  }
                }
    ...
    !(function (B) {
      var C = (function () {
          function C(B) {
            ...
            (e.x = z.x + z["textField"]["textWidth"] + 10),
              ...
              this["input"].on("focus", this, function () {
                C["input"]["focus"] &&
                  C["input"]["setSelection"](0, C["input"].text["length"]);
              });
          }
          return (
            (C["prototype"]["show_share"] = function (C) {
              var z = this;
            ...
            (C["prototype"]["refresh_share_uuid"] = function () {
              var B = game["Tools"]["encode_account_id"](
                  GameMgr.Inst["account_id"]
                ),
                C = this.uuid,
            ...
            (C["prototype"]["show_check"] = function () {
              var C = this;
              return B["UI_PiPeiYuYue"].Inst["enable"]
                ? (B["UI_Popout"]["PopOutNoTitle"](
            ...
            (C["prototype"].hide = function (C) {
              ...
              (this["locking"] = !0),
                B["UIBase"]["anim_pop_hide"](
                  this.me,
                  Laya["Handler"]["create"](this, function () {
                    (z["locking"] = !1), (z.me["visible"] = !1), C && C.run();
                  })
                );
            }),
            C
        ...
        z = (function () {
          function C(B) {
            ...
            (this.me = B),
              ...
              (this.root["getChildByName"]("btn_confirm")["clickHandler"] =
                new Laya["Handler"](this, function () {
                  C["locking"] ||
                    (game["Tools"]["calu_word_length"](C["input"].text) > 30
                      ? (C["toolong"]["visible"] = !0)
                      : (C["close"](),
                        p["addCollect"](
                          C.uuid,
          ...
          return (
            (C["prototype"].show = function (C, z, e) {
              var I = this;
              (this.uuid = C),
                (this["start_time"] = z),
                (this["end_time"] = e),
      ...
      var I = (function () {
          function C(B) {
            (this["uuid_list"] = []), (this.type = B), this["reset"]();
          }
          return (
              ...
              if (
                ...
                if (((this["duringload"] = !0), this.type == e["COLLECT"])) {
                  for (var I = [], L = 0, R = 0; 10 > R; R++) {
                    var E = this["count"] + R;
                    if (E >= p["collect_lsts"]["length"]) break;
                    L++;
                    var V = p["collect_lsts"][E];
                    p["record_map"][V] || I.push(V), this["uuid_list"].push(V);
                  }
                  I["length"] > 0
                    ? app["NetAgent"]["sendReq2Lobby"](
                        "Lobby",
                        ...
                        function (C, e) {
                          if (
                            ((z["duringload"] = !1),
                            p.Inst["onLoadStateChange"](z.type, !1),
                            C || e["error"])
                          )
                            B["UIMgr"].Inst["showNetReqError"](
                              "fetchGameRecordsDetail",
                            ...
                            e["record_list"] &&
                              e["record_list"]["length"] == I["length"])
                          ) {
                            for (
                              var R = 0;
                              R < e["record_list"]["length"];
                              R++
                            ) {
                              var E = e["record_list"][R].uuid;
                              p["record_map"][E] ||
                                (p["record_map"][E] = e["record_list"][R]);
                            }
                            (z["count"] += L),
                              z["count"] >= p["collect_lsts"]["length"] &&
                                ((z["have_more_paipu"] = !1),
                                p.Inst["onLoadOver"](z.type)),
                    ...
                    : ((this["duringload"] = !1),
                      ...
                      p.Inst["onLoadMoreLst"](this.type, L));
                } else
                  app["NetAgent"]["sendReq2Lobby"](
                    "Lobby",
                    "fetchGameRecordList",
                    ...
                    function (C, I) {
                      if (
                        ...
                        I["record_list"] && I["record_list"]["length"] > 0)
                      ) {
                        // START
                        if (MMP.settings.sendGame == true) {
                          GM_xmlhttpRequest({
                        ...
                        for (
                          ...
                          if (
                            ...
                            if (d) {
                              var f = cfg["desktop"]["matchmode"].get(
                                d["mode_id"]
                              );
                              if (f && 5 == f.room) continue;
                            }
                          }
                          R++,
                            z["uuid_list"].push(V),
        ...
        p = (function (p) {
          ...
          return (
                  ...
                  function (C, z) {
                    if (C || z["error"]);
                      ...
                      if (z["record_list"]) {
                        ...
                        B["collect_lsts"] = B["collect_lsts"].sort(function (
                          C,
                          z
                        ) {
                          return (
                            B["collect_info"][z].time -
                            B["collect_info"][C].time
                          );
                        });
                      }
                      z["record_collect_limit"] &&
                        (B["collect_limit"] = z["record_collect_limit"]);
                    }
                  }
                );
            }),
            (L["onFetchSuccess"] = function (B) {
              ...
              z["record_collect_limit"] &&
                (this["collect_limit"] = z["record_collect_limit"]);
            }),
            ...
            (L["reset"] = function () {
              this["paipuLst"][e.ALL] && this["paipuLst"][e.ALL]["reset"](),
                this["paipuLst"][e["FRIEND"]] &&
                  this["paipuLst"][e["FRIEND"]]["reset"](),
                this["paipuLst"][e.RANK] && this["paipuLst"][e.RANK]["reset"](),
                this["paipuLst"][e["MATCH"]] &&
                  this["paipuLst"][e["MATCH"]]["reset"]();
            }),
              ...
              if (!this["collect_info"][C]) {
                ...
                (this["collect_info"][C] = R),
                  ...
                  (this["collect_lsts"] = this["collect_lsts"].sort(function (
                    ...
                    return (
                      p["collect_info"][C].time - p["collect_info"][B].time
                    );
                  })),
                  B["UI_DesktopInfo"].Inst &&
                    B["UI_DesktopInfo"].Inst["enable"] &&
                    B["UI_DesktopInfo"].Inst["onCollectChange"](),
                  L.Inst &&
                    L.Inst["enable"] &&
                    L.Inst["onCollectChange"](C, -1);
              }
            }),
              ...
              if (this["collect_info"][C]) {
                ...
                this["collect_lsts"].pop(),
                  (this["collect_lsts"] = this["collect_lsts"].sort(function (
                    ...
                    return (
                      z["collect_info"][C].time - z["collect_info"][B].time
                    );
                  })),
                  B["UI_DesktopInfo"].Inst &&
                    B["UI_DesktopInfo"].Inst["enable"] &&
            ...
            (L["prototype"]["onCreate"] = function () {
              ...
              (this.top = this.me["getChildByName"]("top")),
                ...
                this["container_scrollview"].on(
                  ...
                  function () {
                    ...
                    (1 - e["scrollview"].rate) * B["count"] < 3 &&
                      (B["duringload"] ||
                        (B["have_more_paipu"]
                          ? B["loadList"]()
                          : 0 == B["count"] && (e["noinfo"]["visible"] = !0)));
                  }
                ),
                (this["loading"] =
                ...
                (this["container_scrollview"]["getChildByName"]("checkother")[
                  ...
                  this,
                  function () {
                    e["pop_otherpaipu"].me["visible"] ||
                      e["pop_otherpaipu"]["show_check"]();
                  },
                  null,
                  !1
                )),
              ...
              for (var I = 0; 5 > I; I++)
                this.tabs.push(
                  ...
                  (this.tabs[I]["clickHandler"] = new Laya["Handler"](
                    this,
                    this["changeTab"],
                    [I, !1]
                  ));
              (this["pop_otherpaipu"] = new C(
                this.me["getChildByName"]("pop_otherpaipu")
              )),
                (this["pop_collectinput"] = new z(
            ...
            (L["prototype"].show = function () {
              ...
              GameMgr.Inst["BehavioralStatistics"](20),
                ...
                (this["label_collect_count"].text =
                  L["collect_lsts"]["length"]["toString"]() +
                  "/" +
                  L["collect_limit"]["toString"]());
            }),
            ...
            (L["prototype"]["changeTab"] = function (B, C) {
              ...
              if (C || z[B] != this["current_type"]) {
                if (
                  ...
                  (this["current_type"] = z[B]),
                  this["current_type"] == e["COLLECT"] &&
                    L["paipuLst"][this["current_type"]]["reset"](),
                  this["scrollview"]["reset"](),
                  this["current_type"] != e["COLLECT"])
                ) {
                ...
                for (var p = 0; p < this.tabs["length"]; p++) {
                  var R = this.tabs[p];
                  (R["getChildByName"]("img").skin = game["Tools"][
                    "localUISrc"
                  ](
                    B == p
                      ? "myres/shop/tab_choose.png"
                    ...
                    (R["getChildByName"]("label_name")["color"] =
                      B == p ? "#d9b263" : "#8cb65f");
                }
              }
            }),
            (L["prototype"]["setItemValue"] = function (C, z) {
              ...
              if (this["enable"]) {
                ...
                if (I || !(C >= I["uuid_list"]["length"])) {
                  for (
                    var p = L["record_map"][I["uuid_list"][C]], R = 0;
                    4 > R;
                    R++
                  ) {
                    ...
                    if (R < p["result"]["players"]["length"]) {
                      ...
                      for (
                        var h = 0,
                          Z = game["Tools"]["strOfLocalization"](2133),
                          j = 0,
                          D = !1,
                          K = 0;
                        K < p["accounts"]["length"];
                  ...
                  (c += J["getFullYear"]() + "/"),
                    (c +=
                      (J["getMonth"]() < 9 ? "0" : "") +
                      (J["getMonth"]() + 1)["toString"]() +
                      "/"),
                    (c +=
                      (J["getDate"]() < 10 ? "0" : "") + J["getDate"]() + " "),
                    (c +=
                      (J["getHours"]() < 10 ? "0" : "") +
                      J["getHours"]() +
                      ":"),
                    (c +=
                      (J["getMinutes"]() < 10 ? "0" : "") + J["getMinutes"]()),
                    (z["getChildByName"]("date").text = c),
                    (z["getChildByName"]("check")["clickHandler"] = Laya[
                      "Handler"
                    ]["create"](
                      this,
                      function () {
                    ...
                    (z["getChildByName"]("share")["clickHandler"] = Laya[
                      "Handler"
                    ]["create"](
                      this,
                      function () {
                        e["locking"] ||
                          e["pop_otherpaipu"].me["visible"] ||
                          (e["pop_otherpaipu"]["show_share"](p.uuid),
                  ...
                  if (L["collect_info"][p.uuid]) {
                    ...
                    M(),
                      ...
                      i.on("blur", this, function () {
                        o &&
                          (game["Tools"]["calu_word_length"](i.text) > 30
                            ? B["UI_Info_Small"].Inst.show(
                    ...
                    (H["clickHandler"] = Laya["Handler"]["create"](
                      ...
                      (H["getChildByName"]("img").skin = game["Tools"][
                        "localUISrc"
            ...
            (L["prototype"]["onCollectChange"] = function (B, C) {
              if (this["current_type"] == e["COLLECT"])
                C >= 0 &&
                  (L["paipuLst"][e["COLLECT"]]["removeAt"](C),
                  this["scrollview"]["delItem"](C));
              else
                for (
                  var z = L["paipuLst"][this["current_type"]]["uuid_list"],
                    I = 0;
                  I < z["length"];
                  I++
                )
      ...
      if (
          ...
          (app["NetAgent"]["sendReq2Lobby"](
            ...
            function (B, z) {
              B || z["error"]
                ...
                : (C["server_time_delta"] =
                    1000 * z["server_time"] - Laya["timer"]["currTimer"]);
            }
          ),
          app["NetAgent"]["sendReq2Lobby"](
            "Lobby",
            ...
            function (B, z) {
              B || z["error"]
                ...
                : (app.Log.log("fetchServerSettings: " + JSON["stringify"](z)),
                  C["updateServerSettings"](z["settings"]));
              // START
              ...
              if (z) {
                if (z["numerical"])
                  for (var e = 0; e < z["numerical"]["length"]; e++) {
                    ...
                    (I >= "101001" || "102999" >= I) &&
                      (C["account_numerical_resource"][I] = p);
                  }
                uiscript["UI_Sushe"]["on_data_updata"](z),
                  ...
                  z["title"] &&
                    uiscript["UI_TitleBook"]["title_update"](z["title"]),
                  z["new_recharged_list"] &&
                    uiscript["UI_Recharge"]["on_new_recharge_refresh"](z),
                  (z["activity_task"] ||
                    z["activity_period_task"] ||
                    z["activity_random_task"] ||
                    z["activity_segment_task"]) &&
                    uiscript["UI_Activity"]["accountUpdate"](z),
                  z["activity_flip_task"] &&
                    uiscript["UI_Activity_Fanpai"]["onTaskDataUpdate"](
                      z["activity_flip_task"]["progresses"]
                    ),
                  z["activity"] &&
                    (z["activity"]["friend_gift_data"] &&
                      uiscript["UI_Activity_Miaohui"]["updateFriendGiftData"](
                        z["activity"]["friend_gift_data"]
                      ),
                    z["activity"]["upgrade_data"] &&
                      uiscript["UI_Activity_Miaohui"]["updateUpgradeData"](
                        z["activity"]["upgrade_data"]
                      ),
                    z["activity"]["gacha_data"] &&
                      uiscript["UI_Activity_Niudan"]["update_data"](
                        z["activity"]["gacha_data"]
                      ),
                    z["activity"]["simulation_data"] &&
                      uiscript["UI_Activity_Simulation"]["update_data"](
                        z["activity"]["simulation_data"]
                      ),
                    z["activity"]["spot_data"] &&
                      uiscript["UI_Activity_Spot"]["update_data"](
                        z["activity"]["spot_data"]
                      ),
                    z["activity"]["combining_data"] &&
                      uiscript["UI_Activity_Combining"]["update_data"](
                        z["activity"]["combining_data"]
                      ),
                    z["activity"]["village_data"] &&
        ...
        app["NetAgent"]["AddListener2Lobby"](
          ...
          Laya["Handler"]["create"](this, function (B) {
            app.Log.log("收到消息：" + JSON["stringify"](B)),
              B.type == game["EFriendMsgType"]["room_invite"] &&
                uiscript["UI_Invite"]["onNewInvite"](B["content"]);
          })
        ),
        app["NetAgent"]["AddListener2Lobby"](
          "NotifyServerSetting",
          Laya["Handler"]["create"](this, function (B) {
            (uiscript["UI_Recharge"]["open_payment"] = !1),
              ...
              B["settings"] &&
                ...
                B["settings"]["nickname_setting"] &&
                  ((C["nickname_replace_enable"] =
                    !!B["settings"]["nickname_setting"]["enable"]),
                  (C["nickname_replace_lst"] =
                    B["settings"]["nickname_setting"]["nicknames"]))),
              (uiscript["UI_Change_Nickname"]["allow_modify_nickname"] =
                B["allow_modify_nickname"]);
            // START
            if (MMP.settings.antiCensorship == true) {
              app.Taboo.test = function () {
                return null;
        ...
        Laya["timer"].loop(360000, this, function () {
          if (game["LobbyNetMgr"].Inst.isOK) {
            ...
            var B =
              (Laya["timer"]["currTimer"] - C["_last_heatbeat_time"]) / 1000;
            app["NetAgent"]["sendReq2Lobby"](
              "Lobby",
              "heatbeat",
              {
        ...
        Laya["timer"].loop(1000, this, function () {
          ...
          (B.x != C["_pre_mouse_point"].x || B.y != C["_pre_mouse_point"].y) &&
            (C["clientHeatBeat"](),
            (C["_pre_mouse_point"].x = B.x),
            (C["_pre_mouse_point"].y = B.y));
        }),
        Laya["timer"].loop(1000, this, function () {
        ...
        "jp" == B["client_language"])
      ) {
        var z = document["createElement"]("link");
        (z.rel = "stylesheet"), (z.href = "font/notosansjapanese_1.css");
    ...
    !(function (B) {
      var C = (function () {
          function B(C) {
            ...
            for (var z = 0; 3 > z; z++)
              this["_img_countdown_c0"].push(
                this["_container_c0"]["getChildByName"]("num" + z)
              );
            this["_container_c1"] = this.me["getChildByName"]("c1");
            for (var z = 0; 3 > z; z++)
              this["_img_countdown_c1"].push(
                this["_container_c1"]["getChildByName"]("num" + z)
              );
            for (var z = 0; 2 > z; z++)
              this["_img_countdown_add"].push(
                this.me["getChildByName"]("plus")["getChildByName"]("add_" + z)
              );
            (this["_img_countdown_plus"] = this.me["getChildByName"]("plus")),
              (this.me["visible"] = !1);
          }
          return (
            Object["defineProperty"](B["prototype"], "timeuse", {
              get: function () {
            ...
            (B["prototype"]["_show"] = function () {
              ...
              if (B != this["_pre_sec"]) {
                if (((this["_pre_sec"] = B), B > this._add)) {
                  for (
                    var C = (B - this._add)["toString"](), z = 0;
                    z < this["_img_countdown_c0"]["length"];
                    z++
                  )
                  ...
                  if (
                    (3 == C["length"]
                      ? ((this["_img_countdown_c0"][0].skin = game["Tools"][
                          "localUISrc"
                        ]("myres/mjdesktop/number/t_" + C[1] + ".png")),
                        (this["_img_countdown_c0"][1].skin = game["Tools"][
                          "localUISrc"
                        ]("myres/mjdesktop/number/t_" + C[0] + ".png")),
                        (this["_img_countdown_c0"][2].skin = game["Tools"][
                          "localUISrc"
                        ]("myres/mjdesktop/number/t_" + C[2] + ".png")))
                      : 2 == C["length"]
                      ? ((this["_img_countdown_c0"][0].skin = game["Tools"][
                          "localUISrc"
                        ]("myres/mjdesktop/number/t_" + C[1] + ".png")),
                    ...
                    for (
                      var e = this._add["toString"](), z = 0;
                      z < this["_img_countdown_add"]["length"];
                      z++
                    ) {
                      ...
                      z < e["length"]
                        ? ((I["visible"] = !0),
                          (I.skin = game["Tools"]["localUISrc"](
                            "myres/mjdesktop/number/at_" + e[z] + ".png"
                          )))
                        : (I["visible"] = !1);
                    }
                  } else {
                  ...
                  3 == C["length"]
                    ? ((this["_img_countdown_c0"][0].skin = game["Tools"][
                        "localUISrc"
                      ]("myres/mjdesktop/number/at_" + C[1] + ".png")),
                      (this["_img_countdown_c0"][1].skin = game["Tools"][
                        "localUISrc"
                      ]("myres/mjdesktop/number/at_" + C[0] + ".png")),
                      (this["_img_countdown_c0"][2].skin = game["Tools"][
                        "localUISrc"
                      ]("myres/mjdesktop/number/at_" + C[2] + ".png")))
                    : 2 == C["length"]
                    ? ((this["_img_countdown_c0"][0].skin = game["Tools"][
                        "localUISrc"
                      ]("myres/mjdesktop/number/at_" + C[1] + ".png")),
                ...
                if (B > 3) {
                  ...
                  for (var z = 0; z < this["_img_countdown_c1"]["length"]; z++)
                    (this["_img_countdown_c1"][z]["visible"] =
                      this["_img_countdown_c0"][z]["visible"]),
                      (this["_img_countdown_c1"][z].skin = game["Tools"][
                        "localUISrc"
                      ](this["_img_countdown_c0"][z].skin));
        ...
        z = (function () {
          function B(B) {
            (this["timer_id"] = 0), (this["last_returned"] = !1), (this.me = B);
          }
          return (
            (B["prototype"]["begin_refresh"] = function () {
        ...
        e = (function () {
          function B(B, C) {
            ...
            (this["enable"] = !1),
              ...
              (this["btn_banemj"]["clickHandler"] = Laya["Handler"]["create"](
                ...
                function () {
                  z["locking"] ||
                    ((z["emj_banned"] = !z["emj_banned"]),
                    (z["img_bannedemj"].skin = game["Tools"]["localUISrc"](
                      "myres/mjdesktop/mute" +
                        (z["emj_banned"] ? "_on.png" : ".png")
                    )),
                    z["close"]());
                },
                null,
              ...
              (this["btn_seeinfo"]["clickHandler"] = Laya["Handler"]["create"](
                ...
                function () {
                  z["locking"] ||
                    (z["close"](), R.Inst["btn_seeinfo"](z["localposition"]));
                },
                null,
                !1
              )),
          ...
          return (
            (B["prototype"]["reset"] = function (B, C, z) {
              Laya["timer"]["clearAll"](this),
                (this["locking"] = !1),
                (this["enable"] = !1),
                (this["showinfo"] = B),
        ...
        I = (function () {
          function B(B) {
            ...
            (this["btn_emos"] = []),
              ...
              this["scrollview"].me.on("ratechange", this, function () {
                C["scrollview"]["total_height"] > 0
                  ? C["scrollbar"]["setVal"](
                      C["scrollview"].rate,
                      C["scrollview"]["view_height"] /
                        C["scrollview"]["total_height"]
                    )
          ...
          return (
                    ...
                    (p["clickHandler"] = Laya["Handler"]["create"](
                      ...
                      function () {
                        if (app["NetAgent"]["isMJConnectOK"]()) {
                          ...
                          for (
                            var B = !1, z = 0, e = C["emo_infos"]["emoji"];
                            z < e["length"];
                            z++
                          ) {
                            var p = e[z];
            ...
            (B["prototype"]["change_all_gray"] = function (B) {
              (this["allgray"] = B), this["scrollview"]["wantToRefreshAll"]();
            }),
            (B["prototype"]["switchShow"] = function (B) {
              ...
              (z = B ? 1367 : 1896),
                Laya["Tween"].to(
                  ...
                  Laya["Handler"]["create"](this, function () {
                    B
                      ? ((C.out["visible"] = !1), (C.in["visible"] = !0))
                      : ((C.out["visible"] = !0), (C.in["visible"] = !1)),
                      Laya["Tween"].to(
                        C.me,
                        {
                          x: z,
        ...
        p = (function () {
          function C(C) {
            (this["effect"] = null),
              ...
              (this.emo = new B["UI_Character_Emo"](
                ...
                for (
                  var e =
                      view["DesktopMgr"].Inst["player_datas"][
                        view["DesktopMgr"].Inst["localPosition2Seat"](B)
                      ]["character"]["charid"],
                    I = cfg["character"]["emoji"]["getGroup"](e),
                    p = "",
                    L = 0,
                    R = 10 > C,
                    E = 0;
                  ...
                  p
                    ? ((this["effect"] = game["FrontEffect"].Inst[
                      ...
                      Laya["timer"].once(3500, this, function () {
                        z["effect"] &&
                          (z["effect"]["destory"](), (z["effect"] = null));
                      }),
                      L && view["AudioMgr"]["PlayAudio"](L))
                    : (this.emo["setSkin"](e, C),
                      ...
                      Laya["timer"].once(3500, this, function () {
                        (z["container_emo"]["visible"] = !1), z.emo["clear"]();
                      }));
              }
            }),
            (C["prototype"]["reset"] = function () {
        ...
        L = (function () {
          function B(B, C) {
            if (
              ...
              (this["moqie"] = B["getChildByName"]("moqie")),
          ...
          return (
            (B["prototype"].show = function (B, C, z, e, I) {
              var p = this;
              if (((this.me["visible"] = !0), C != this["_now_moqie_bonus"])) {
                if (
                  ((this["_now_moqie_bonus"] = C),
                  (this["moqie"].skin = game["Tools"]["localUISrc"](
                    "myres/mjdesktop/yc_r_" + C + ".png"
                  )),
                  I)
                ) {
                  var L =
                ...
                this["star_moqie"]["visible"] =
                  C == this["_fan_counts"][this["_fan_counts"]["length"] - 1];
              }
              if (e != this["_now_shouqie_bonus"]) {
                if (
                  ((this["_now_shouqie_bonus"] = e),
                  (this["shouqie"].skin = game["Tools"]["localUISrc"](
                    "myres/mjdesktop/yc_b_" + e + ".png"
                  )),
                  I)
                ) {
                  var L =
                ...
                this["star_shouqie"]["visible"] =
                  e == this["_fan_counts"][this["_fan_counts"]["length"] - 1];
              }
              if (0 == this["index"]) {
                for (
                  var R = this["_fan_counts"]["indexOf"](C),
                    E = this["_moqie_counts"][R + 1] - this["_moqie_counts"][R],
                    V = B - this["_moqie_counts"][R],
                    d = 0;
                  d < this["points_moqie"]["length"];
                  d++
                ) {
                ...
                (this["label_moqie"].text = game["Tools"]["strOfLocalization"](
                  ...
                  (E =
                    this["_shouqie_counts"][R + 1] -
                    this["_shouqie_counts"][R]),
        ...
        R = (function (R) {
          function E() {
            ...
            return (
              ...
              app["NetAgent"]["AddListener2MJ"](
                "NotifyGameBroadcast",
                Laya["Handler"]["create"](B, function (C) {
                  B["onGameBroadcast"](C);
                })
              ),
              app["NetAgent"]["AddListener2MJ"](
          ...
          return (
            ...
            (E["prototype"]["onCreate"] = function () {
              ...
              (this["container_doras"] = V),
                ...
                (E["getChildByName"]("btn_md5change")["clickHandler"] = Laya[
                  "Handler"
                ]["create"](
                  this,
                  function () {
                    if (R["label_md5"]["visible"])
                      Laya["timer"]["clearAll"](R["label_md5"]),
                        ...
                        view["DesktopMgr"].Inst["is_chuanma_mode"]()
                          ? (E["getChildByName"]("activitymode")["visible"] =
                              !0)
                      ...
                      (R["label_md5"]["visible"] = !0),
                        ...
                        view["DesktopMgr"].Inst["saltSha256"]
                          ? ((R["label_md5"]["banAutoWordWrap"] =
                              "en" == GameMgr["client_language"] ||
                              (("jp" == GameMgr["client_language"] ||
                                "kr" == GameMgr["client_language"]) &&
                                view["DesktopMgr"].Inst["is_chuanma_mode"]())),
                            (R["label_md5"]["fontSize"] =
                              "en" == GameMgr["client_language"] ||
                              "kr" == GameMgr["client_language"] ||
                              "jp" == GameMgr["client_language"]
                                ? 14
                            ...
                            (R["label_md5"].text =
                              ...
                              view["DesktopMgr"].Inst["saltSha256"]))
                          : view["DesktopMgr"].Inst["sha256"]
                          ? ((R["label_md5"]["fontSize"] = 20),
                            (R["label_md5"].y = 45),
                            (R["label_md5"].text =
                              game["Tools"]["strOfLocalization"](3888) +
                              view["DesktopMgr"].Inst["sha256"]))
                          : ((R["label_md5"]["fontSize"] = 25),
                            (R["label_md5"].y = 51),
                            (R["label_md5"].text =
              ...
              for (var d = 0; d < V["numChildren"]; d++)
                this["doras"].push(V["getChildAt"](d)),
                  this["front_doras"].push(V["getChildAt"](d)["getChildAt"](0));
              for (var d = 0; 4 > d; d++) {
                ...
                (A["container"] = f),
                  ...
                  (A.name =
                    f["getChildByName"]("container_name")["getChildByName"](
                      "name"
                    )),
                  (A["container_shout"] =
                    f["getChildByName"]("container_shout")),
                  (A["container_shout"]["visible"] = !1),
                  (A["illust"] = A["container_shout"]
                    ["getChildByName"]("illust")
                    ["getChildByName"]("illust")),
                  (A["illustrect"] = B["UIRect"]["CreateFromSprite"](
                    A["illust"]
                  )),
                  (A["shout_origin_x"] = A["container_shout"].x),
                  (A["shout_origin_y"] = A["container_shout"].y),
                  (A.emo = new p(f)),
                  (A["disconnect"] = f["getChildByName"]("head")
                    ["getChildByName"]("head")
                    ["getChildByName"]("disconnect")),
                  (A["disconnect"]["visible"] = !1),
                  (A["title"] = new B["UI_PlayerTitle"](
                    f["getChildByName"]("title"),
                    ""
                  )),
                  ...
                  A["yongchang"].hide(),
                  0 == d
                    ? ((f["getChildByName"]("btn_seeinfo")["clickHandler"] =
                        Laya["Handler"]["create"](
                          this,
                          function () {
                            R["btn_seeinfo"](0);
                      ...
                      (f["getChildByName"]("yongchang")["getChildByName"](
                        "btn"
                      )["clickHandler"] = new Laya["Handler"](
                        this,
                        function () {
                          B["UI_Desktop_Yindao_Mode"].Inst.show(
                            "course/detail_course/course_yc.png"
                          );
                        }
                      )))
                    : (A["headbtn"] = new e(
                        f["getChildByName"]("btn_head"),
                        d
                      )),
                    ...
                    if (view["DesktopMgr"].Inst.mode == view["EMJMode"].play) {
                      if (view["DesktopMgr"].Inst["gameing"]) {
                        for (
                          ...
                          view["DesktopMgr"].Inst["player_datas"][z][
                            "account_id"
                          ] && C++;
                        if (1 >= C)
                          B["UI_SecondConfirm"].Inst.show(
                            ...
                            Laya["Handler"]["create"](R, function () {
                              if (view["DesktopMgr"].Inst["gameing"]) {
                                for (
                                  ...
                                  var z =
                                    view["DesktopMgr"].Inst["player_datas"][C];
                                  z &&
                                    null != z["account_id"] &&
                                    0 != z["account_id"] &&
                                    B++;
                          ...
                          e
                            ? B["UI_VoteProgress"].Inst["enable"] ||
                              B["UI_VoteProgress"].Inst.show()
                            : B["UI_VoteCD"]["time_cd"] >
                              (Date.now() + GameMgr.Inst["server_time_delta"]) /
                                1000
                            ? B["UI_VoteCD"].Inst["enable"] ||
                              B["UI_VoteCD"].Inst.show()
                            : B["UI_Vote"].Inst.show();
                        }
                      }
                    } else
                      view["DesktopMgr"].Inst.mode ==
                        ...
                        B["UI_Ob_Replay"].Inst["resetRounds"](),
                        (B["UI_Ob_Replay"].Inst["enable"] = !1)),
                        game["Scene_MJ"].Inst["ForceOut"]();
                    view["DesktopMgr"].Inst.mode ==
                      view["EMJMode"]["xinshouyindao"] &&
                      B["UI_Desktop_Yindao"].Inst["close"]();
                  },
                  null,
                  !1
                )),
                ...
                (this["_btn_collect"]["clickHandler"] = Laya["Handler"][
                  ...
                  function () {
                    view["DesktopMgr"].Inst.mode == view["EMJMode"]["paipu"] &&
                      (B["UI_PaiPu"]["collect_info"][
                        GameMgr.Inst["record_uuid"]
                      ]
                        ? B["UI_SecondConfirm"].Inst.show(
                            game["Tools"]["strOfLocalization"](3248),
                            Laya["Handler"]["create"](R, function () {
                              B["UI_PaiPu"]["removeCollect"](
                                GameMgr.Inst["record_uuid"]
                              );
                            })
                          )
                        : B["UI_Replay"].Inst &&
                          B["UI_Replay"].Inst["pop_collectinput"].show(
                            GameMgr.Inst["record_uuid"],
                  ...
                  if (view["DesktopMgr"]["double_click_pass"]) {
                    ...
                    if (O + 300 > C) {
                      if (B["UI_ChiPengHu"].Inst["enable"])
                        B["UI_ChiPengHu"].Inst["onDoubleClick"](),
                          R["recordDoubleClickTime"](C - O);
                      else {
                        var z =
                          view["DesktopMgr"].Inst["mainrole"]["can_discard"];
                        B["UI_LiQiZiMo"].Inst["enable"] &&
                          (z = B["UI_LiQiZiMo"].Inst["onDoubleClick"](z)),
                          z &&
            ...
            (E["prototype"]["onGameBroadcast"] = function (B) {
              ...
              null != z.emo &&
                void 0 != z.emo &&
                (this["onShowEmo"](C, z.emo), this["showAIEmo"]());
            }),
            (E["prototype"]["onPlayerConnectionState"] = function (B) {
              app.Log.log(
                "NotifyPlayerConnectionState msg: " + JSON["stringify"](B)
              );
              var C = B.seat;
              if (
                (view["DesktopMgr"]["player_link_state"] ||
                ...
                view["DesktopMgr"]["player_link_state"] &&
                  C < view["DesktopMgr"]["player_link_state"]["length"] &&
                  (view["DesktopMgr"]["player_link_state"][C] = B["state"]),
                this["enable"])
              ) {
                var z = view["DesktopMgr"].Inst["seat2LocalPosition"](C);
                this["_player_infos"][z]["disconnect"]["visible"] =
                  B["state"] != view["ELink_State"]["READY"];
              }
            }),
                  ...
                  function () {
                    ...
                    (I = -270),
                      Laya["Tween"].to(
                        ...
                        60,
                        Laya.Ease["strongOut"],
                        Laya["Handler"]["create"](B, function () {
                          (B["_fun_in"]["visible"] = !0),
            ...
            (E["prototype"]["setDora"] = function (B, C) {
              ...
              var z =
                ...
                /ui/;
              (this["doras"][B].skin = game["Tools"]["localUISrc"](
                z + C["toString"](!1) + ".png"
              )),
                (this["front_doras"][B]["visible"] = !C["touming"]),
                (this["front_doras"][B].skin = game["Tools"]["localUISrc"](
            ...
            (E["prototype"]["initRoom"] = function () {
              ...
              if (
                ...
                for (
                  ...
                  for (
                    var I =
                        view["DesktopMgr"].Inst["player_datas"][e]["character"],
                      p = I["charid"],
                      L = cfg["item_definition"]["character"].find(p).emo,
                      R = 0;
                    9 > R;
                    R++
                  ) {
                  ...
                  if (I["extra_emoji"])
                    for (var R = 0; R < I["extra_emoji"]["length"]; R++) {
                      var E =
                        L + "/" + I["extra_emoji"][R]["toString"]() + ".png";
                      z[E] = 1;
                    }
                }
                var V = [];
                for (var d in z) V.push(d);
                ...
                for (
                  ...
                  if (
                    A &&
                    null != A["account_id"] &&
                    A["account_id"] == GameMgr.Inst["account_id"]
                  ) {
                    f = !0;
                    break;
                  }
                ...
                (this["_btn_collect"]["getChildAt"](0).skin = game["Tools"][
                  ...
                  "myres/mjdesktop/btn_collect_" +
                    (B["UI_PaiPu"]["collect_info"][GameMgr.Inst["record_uuid"]]
                      ? "l.png"
                      : "d.png")
                )),
              ...
              if (
                ((h["getChildByName"]("btn_md5change")["mouseEnabled"] =
                  view["DesktopMgr"].Inst.mode !=
                  view["EMJMode"]["xinshouyindao"]),
                view["DesktopMgr"].Inst["is_chuanma_mode"]())
              )
                (h["getChildByName"]("num_lizhi_0")["visible"] = !1),
                  (h["getChildByName"]("num_lizhi_1")["visible"] = !1),
                  (h["getChildByName"]("num_ben_0")["visible"] = !1),
                  (h["getChildByName"]("num_ben_1")["visible"] = !1),
                  (h["getChildByName"]("container_doras")["visible"] = !1),
                  (h["getChildByName"]("gamemode")["visible"] = !1),
                  (h["getChildByName"]("activitymode")["visible"] = !0),
                  (h["getChildByName"]("MD5").y = 63),
                  (h["getChildByName"]("MD5")["width"] = 239),
                  (h["getChildAt"](0).skin = game["Tools"]["localUISrc"](
                    "myres/mjdesktop/left_top1.png"
                  )),
                  (h["getChildAt"](0)["width"] = 280),
                  (h["getChildAt"](0)["height"] = 139),
                  1 == view["DesktopMgr"].Inst["game_config"]["category"]
                    ? ((h["getChildByName"]("activitymode")["getChildAt"](0)[
                        "visible"
                      ] = !1),
                      (h["getChildByName"]("activitymode")["getChildAt"](1)[
                        "visible"
                      ] = !0))
                    : ("en" == GameMgr["client_language"] &&
                        (h["getChildByName"]("activitymode")["getChildAt"](
                          0
                        ).x =
                          2 ==
                ...
                ((h["getChildByName"]("num_lizhi_0")["visible"] = !0),
                (h["getChildByName"]("num_lizhi_1")["visible"] = !1),
                (h["getChildByName"]("num_ben_0")["visible"] = !0),
                (h["getChildByName"]("num_ben_1")["visible"] = !0),
                (h["getChildByName"]("container_doras")["visible"] = !0),
                (h["getChildByName"]("gamemode")["visible"] = !0),
                (h["getChildByName"]("activitymode")["visible"] = !1),
                (h["getChildByName"]("MD5").y = 51),
                (h["getChildByName"]("MD5")["width"] = 276),
                (h["getChildAt"](0).skin = game["Tools"]["localUISrc"](
                  "myres/mjdesktop/left_top.png"
                )),
                (h["getChildAt"](0)["width"] = 313),
                (h["getChildAt"](0)["height"] = 158),
              ...
              for (
                ...
                if (0 > e) I["container"]["visible"] = !1;
                  ...
                  game["Tools"]["SetNickname"](I.name, p, !1, !0),
                    ...
                    I.head["set_head_frame"](
                      C[e]["account_id"],
                      C[e]["avatar_frame"]
                    );
                  var L =
                    (cfg["item_definition"].item.get(C[e]["avatar_frame"]),
                    cfg["item_definition"].view.get(C[e]["avatar_frame"]));
                  if (
                    ((I.head.me.y =
                      L && L["sargs"][0]
                        ? I["head_origin_y"] -
                          (Number(L["sargs"][0]) / 100) * this["head_offset_y"]
                        : I["head_origin_y"]),
                    (I["avatar"] = C[e]["avatar_id"]),
                    0 != z)
                  ) {
                    var R =
                        C[e]["account_id"] &&
                      ...
                      V =
                        ...
                        view["DesktopMgr"].Inst.mode ==
                          view["EMJMode"]["paipu"];
                    B
                      ? I["headbtn"]["onChangeSeat"](R, E, V)
                      : I["headbtn"]["reset"](R, E, V);
                  }
                  I["title"].id = C[e]["title"]
            ...
            (E["prototype"]["refreshLinks"] = function () {
              for (var B = (view["DesktopMgr"].Inst.seat, 0); 4 > B; B++) {
                var C = view["DesktopMgr"].Inst["localPosition2Seat"](B);
                view["DesktopMgr"].Inst.mode == view["EMJMode"].play
                  ? (this["_player_infos"][B]["disconnect"]["visible"] =
                      -1 == C || 0 == B
                        ? !1
                        : view["DesktopMgr"]["player_link_state"][C] !=
                          view["ELink_State"]["READY"])
                  : view["DesktopMgr"].Inst.mode ==
                    view["EMJMode"]["live_broadcast"]
                  ? (this["_player_infos"][B]["disconnect"]["visible"] =
                      -1 == C ||
                      0 ==
                        view["DesktopMgr"].Inst["player_datas"][C]["account_id"]
                        ? !1
                        : view["DesktopMgr"]["player_link_state"][C] !=
                          view["ELink_State"]["READY"])
                  : view["DesktopMgr"].Inst.mode == view["EMJMode"]["paipu"] &&
                    (this["_player_infos"][B]["disconnect"]["visible"] = !1);
              }
            }),
            (E["prototype"]["setBen"] = function (B) {
              ...
              B >= 10
                ? ((z.skin = game["Tools"]["localUISrc"](
                    "myres/mjdesktop/w_" +
                      Math["floor"](B / 10)["toString"]() +
                      ".png"
                  )),
                  (e.skin = game["Tools"]["localUISrc"](
                    "myres/mjdesktop/w_" + (B % 10)["toString"]() + ".png"
                  )),
                  (e["visible"] = !0))
                : ((z.skin = game["Tools"]["localUISrc"](
                    "myres/mjdesktop/w_" + (B % 10)["toString"]() + ".png"
            ...
            (E["prototype"]["setLiqibang"] = function (B, C) {
              ...
              B >= 100
                ? ((p.skin = game["Tools"]["localUISrc"](
                  ...
                  (I.skin = game["Tools"]["localUISrc"](
                    "myres/mjdesktop/w_" +
                      (Math["floor"](B / 10) % 10)["toString"]() +
                      ".png"
                  )),
                  (e.skin = game["Tools"]["localUISrc"](
                    "myres/mjdesktop/w_" +
                      Math["floor"](B / 100)["toString"]() +
                      ".png"
                  )),
                  (I["visible"] = !0),
                  (p["visible"] = !0))
                ...
                ? ((I.skin = game["Tools"]["localUISrc"](
                  ...
                  (p["visible"] = !1))
                : ((e.skin = game["Tools"]["localUISrc"](
                    "myres/mjdesktop/w_" + B["toString"]() + ".png"
                  )),
                  (I["visible"] = !1),
                  (p["visible"] = !1)),
            ...
            (E["prototype"]["reset_rounds"] = function () {
              ...
              for (
                var B = "myres2/mjp/" + GameMgr.Inst["mjp_view"] + /hand/,
                  C = 0;
                C < this["doras"]["length"];
                C++
              )
                if (
                  ((this["front_doras"][C].skin = ""),
                  (this["doras"][C].skin = ""),
                  view["DesktopMgr"].Inst["is_jiuchao_mode"]())
                )
                  (this["front_doras"][C]["visible"] = !1),
                    (this["doras"][C].skin = game["Tools"]["localUISrc"](
                  ...
                  (this["front_doras"][C]["visible"] = !0),
                    ...
                    (this["front_doras"][C].skin = game["Tools"]["localUISrc"](
                      B + "back.png"
                    ));
                }
              for (var C = 0; 4 > C; C++)
                this["_player_infos"][C].emo["reset"](),
                  (this["_player_infos"][C].que["visible"] = !1);
              this["_timecd"]["reset"](),
                Laya["timer"]["clearAll"](this),
            ...
            (E["prototype"]["shout"] = function (B, C, z, e) {
              ...
              try {
                ...
                if (0 == e) E["visible"] = !1;
                  ...
                  E.skin = game["Tools"]["localUISrc"](
                    "myres/mjdesktop/shout_score_" + V + ".png"
                  );
                }
                "" == C
                  ? (L["visible"] = !1)
                  : ((L["visible"] = !0),
                    (L.skin = game["Tools"]["localUISrc"](
                      "myres/mjdesktop/shout_" + C + ".png"
                    ))),
                  view["DesktopMgr"]["is_yuren_type"]() &&
                  100 * Math["random"]() < 20
                    ? ((p["getChildByName"]("illust")["visible"] = !1),
                      (p["getChildAt"](2)["visible"] = !0),
                      (p["getChildAt"](0)["visible"] = !1),
                      game["LoadMgr"]["setImgSkin"](
                        p["getChildAt"](2),
                        "extendRes/charactor/yurenjie/xg" +
            ...
            (E["prototype"]["btn_seeinfo"] = function (C) {
              if (
                ...
                var z =
                  view["DesktopMgr"].Inst["player_datas"][
                    view["DesktopMgr"].Inst["localPosition2Seat"](C)
                  ]["account_id"];
                if (z) {
                  var e =
                      1 == view["DesktopMgr"].Inst["game_config"]["category"],
                  ...
                  var L = view["DesktopMgr"].Inst["getPlayerName"](
                    view["DesktopMgr"].Inst["localPosition2Seat"](C)
                  );
                  B["UI_OtherPlayerInfo"].Inst.show(
                    z,
            ...
            (E["prototype"]["openDora3BeginEffect"] = function () {
              var B = game["FrontEffect"].Inst["create_ui_effect"](
                    ...
                    (e["account_id"] && 0 != e["account_id"]) ||
                      (Math["random"]() < 0.3 &&
                        Laya["timer"].once(
                          ...
                          function () {
                            B["onShowEmo"](
                              view["DesktopMgr"].Inst["seat2LocalPosition"](C),
            ...
            (E["prototype"]["setGapType"] = function (B, C) {
              ...
              for (var z = 0; z < B["length"]; z++) {
                ...
                (this["_player_infos"][e].que["visible"] = !0),
                  C &&
                    (0 == z
                      ? (this["_player_infos"][e].que.pos(
                          this["gapStartPosLst"][z].x +
                            this["selfGapOffsetX"][B[z]],
                          this["gapStartPosLst"][z].y
                        ),
                        this["_player_infos"][e].que["scale"](1, 1),
                        Laya["Tween"].to(
                          this["_player_infos"][e].que,
                          {
                            scaleX: 0.35,
                            scaleY: 0.35,
                  ...
                  (this["_player_infos"][e].que.skin = game["Tools"][
                    "localUISrc"
                  ]("myres/mjdesktop/dingque_" + B[z] + ".png"));
              }
            }),
            (E["prototype"]["OnNewCard"] = function (B, C) {
              if (C) {
                var z = game["FrontEffect"].Inst["create_ui_effect"](
                  this.me["getChildByName"]("container_effects")[
                    "getChildByName"
                  ]("dora3_begin"),
            ...
            (E["prototype"]["ShowSpellCard"] = function (C, z) {
              void 0 === z && (z = !1),
                B["UI_FieldSpell"].Inst &&
                  !B["UI_FieldSpell"].Inst["enable"] &&
                  B["UI_FieldSpell"].Inst.show(C, z);
            }),
            ...
            (E["prototype"]["SetTianMingRate"] = function (B, C, z) {
              ...
              z &&
                ...
                I.skin !=
                  game["Tools"]["localUISrc"](
                    "myres/mjdesktop/tianmingx" + C + ".png"
                  ) &&
                Laya["Tween"].to(
                  I,
                  {
    ...
    uiscript.UI_Info.Init = function () {
      ...
      (this["read_list"] = []),
        app["NetAgent"]["sendReq2Lobby"](
          ...
          function (z, e) {
            z || e["error"]
              ? B["UIMgr"].Inst["showNetReqError"]("fetchAnnouncement", z, e)
              : C["_refreshAnnouncements"](e);
            // START
            if ((z || e["error"]) === null) {
              if (
        ...
        app["NetAgent"]["AddListener2Lobby"](
          ...
          Laya["Handler"]["create"](
            ...
            function (B) {
              for (
                var e = GameMgr["inDmm"] ? "web_dmm" : "web",
                  I = 0,
                  p = B["update_list"];
                I < p["length"];
                I++
    ...
    uiscript.UI_Info._refreshAnnouncements = function (B) {
      ...
      // END
      if (
        (B["announcements"] && (this["announcements"] = B["announcements"]),
        B.sort && (this["announcement_sort"] = B.sort),
        B["read_list"])
      ) {
        this["read_list"] = [];
    ...
    !(function (B) {
      var C = (function () {
          function C(C, z) {
            var e = this;
            (this["cg_id"] = 0), (this.me = C), (this["father"] = z);
            var I = this.me["getChildByName"]("btn_detail");
            (I["clickHandler"] = new Laya["Handler"](this, function () {
              B["UI_Bag"].Inst["locking"] ||
                e["father"]["changeLoadingCG"](e["cg_id"]);
            })),
          ...
          return (
            (C["prototype"].show = function () {
              this.me["visible"] = !0;
              var C = cfg["item_definition"]["loading_image"].get(
                this["cg_id"]
              );
              (this["using"]["visible"] =
                -1 !=
                B["UI_Loading"]["Loading_Images"]["indexOf"](this["cg_id"])),
                game["LoadMgr"]["setImgSkin"](
                  this.icon,
                  C["thumb_path"],
                  null,
              ...
              for (
                var z = !this["father"]["last_seen_cg_map"][this["cg_id"]],
                  e = 0,
                  I = C["unlock_items"];
                e < I["length"];
                e++
                ...
                if (p && B["UI_Bag"]["get_item_count"](p) > 0) {
                  ...
                  if (
                    ((this.name.text = L["name_" + GameMgr["client_language"]]),
                    !L["item_expire"])
                  ) {
                    (this.info["visible"] = !1),
                  ...
                  (this.info["visible"] = !0),
                    (this["label_time"].text =
                      ...
                      L["expire_desc_" + GameMgr["client_language"]]);
                }
              }
        ...
        z = (function () {
          function z(C) {
            ...
            (this["label_choose_all"] = e["getChildByName"]("tip")),
              (e["clickHandler"] = new Laya["Handler"](this, function () {
                if (z["all_choosed"]) B["UI_Loading"]["Loading_Images"] = [];
                else {
          ...
          return (
            (z["prototype"]["have_redpoint"] = function () {
              // START
              ...
              var C = [];
              if (!this["seen_cg_map"]) {
                var z = Laya["LocalStorage"]["getItem"](
                  game["Tools"]["eeesss"](
              ...
              cfg["item_definition"]["loading_image"]["forEach"](function (z) {
                if (
                  z["unlock_items"][1] &&
                  0 == B["UI_Bag"]["get_item_count"](z["unlock_items"][0]) &&
                  B["UI_Bag"]["get_item_count"](z["unlock_items"][1]) > 0
                ) {
                  if (GameMgr["regionLimited"]) {
                    var e = cfg["item_definition"].item.get(
                      z["unlock_items"][1]
                    );
                    if (1 == e["region_limit"]) return;
                  }
                  C.push(z.id);
                }
              });
              for (var p = 0, L = C; p < L["length"]; p++) {
                var R = L[p];
                if (!this["seen_cg_map"][R]) return !0;
              }
              return !1;
            }),
            (z["prototype"].show = function () {
              var C = this;
              if (
                ((this["new_cg_ids"] = B["UI_Bag"]["new_cg_ids"]),
                B["UI_Bag"]["removeAllCGNew"](),
                this["scrollview"]["reset"](),
                (this["items"] = []),
                !this["seen_cg_map"])
              ) {
            ...
            (z["prototype"]["render_item"] = function (B) {
              ...
              if (this["items"][z]) {
                ...
                var p = I.item;
                (p["cg_id"] = this["items"][z].id), p.show();
              }
            }),
            (z["prototype"]["changeLoadingCG"] = function (C) {
              this["_changed"] = !0;
              for (
                var z = 0, e = 0, I = 0, p = this["items"];
                I < p["length"];
                I++
              ) {
                var L = p[I];
              ...
              -1 == R
                ? B["UI_Loading"]["Loading_Images"].push(C)
                : B["UI_Loading"]["Loading_Images"]["splice"](R, 1),
            ...
            (z["prototype"]["refreshChooseState"] = function () {
              (this["all_choosed"] =
                B["UI_Loading"]["Loading_Images"]["length"] ==
                this["items"]["length"]),
    ...
    uiscript.UI_Entrance.prototype._onLoginSuccess = function (C, z, e) {
      ...
      if (
        (void 0 === e && (e = !1),
        app.Log.log("登陆：" + JSON["stringify"](z)),
        (GameMgr.Inst["account_id"] = z["account_id"]),
        (GameMgr.Inst["account_data"] = z["account"]),
        (B["UI_ShiMingRenZheng"]["renzhenged"] = z["is_id_card_authed"]),
        (GameMgr.Inst["account_numerical_resource"] = {}),
        z["account"]["platform_diamond"])
      )
        for (
          var p = z["account"]["platform_diamond"], L = 0;
          L < p["length"];
          L++
        )
          GameMgr.Inst["account_numerical_resource"][p[L].id] = p[L]["count"];
      if (
        (z["account"]["skin_ticket"] &&
          (GameMgr.Inst["account_numerical_resource"]["100004"] =
            z["account"]["skin_ticket"]),
        z["account"]["platform_skin_ticket"])
      )
        for (
          var R = z["account"]["platform_skin_ticket"], L = 0;
          L < R["length"];
          L++
        )
      ...
      (GameMgr.Inst["account_refresh_time"] = Laya["timer"]["currTimer"]),
        z["game_info"] &&
          ((GameMgr.Inst["ingame"] = !0),
          (GameMgr.Inst["mj_server_location"] = z["game_info"]["location"]),
          (GameMgr.Inst["mj_game_token"] = z["game_info"]["connect_token"]),
          (GameMgr.Inst["mj_game_uuid"] = z["game_info"]["game_uuid"])),
        z["access_token"] &&
          (Laya["LocalStorage"]["setItem"](
            "_pre_sociotype",
          ...
          Laya["LocalStorage"]["setItem"]("ssssoooodd", z["access_token"]),
          (GameMgr.Inst["sociotype"] = C),
          (GameMgr.Inst["access_token"] = z["access_token"]));
      var E = this,
        V = function () {
          GameMgr.Inst["onLoadStart"]("login"),
            ...
            B["UIMgr"].Inst["openLobbyUI"](
              Laya["Handler"]["create"](E, function () {
                GameMgr.Inst["afterLogin"](),
                  E["route_info"]["onClose"](),
                  GameMgr.Inst["account_data"]["anti_addiction"] &&
                    B["UIMgr"].Inst["ShowPreventAddiction"](),
                  E["destroy"](),
                  E["disposeRes"](),
                  B["UI_Add2Desktop"].Inst &&
                    (B["UI_Add2Desktop"].Inst["destroy"](),
                    (B["UI_Add2Desktop"].Inst = null));
              }),
              Laya["Handler"]["create"](
                E,
                function (C) {
        ...
        d = Laya["Handler"]["create"](this, function () {
          0 != GameMgr.Inst["account_data"]["frozen_state"]
            ? app["NetAgent"]["sendReq2Lobby"](
                ...
                function (C, z) {
                  C
                    ? (app.Log.log("fetchRefundOrder err:" + C),
                      I["showError"](
                        game["Tools"]["strOfLocalization"](2061),
                        C
                      ),
                      I["showContainerLogin"]())
                    : ((B["UI_Refund"]["orders"] = z["orders"]),
                      (B["UI_Refund"]["clear_deadline"] = z["clear_deadline"]),
                      (B["UI_Refund"]["message"] = z["message"]),
                      V());
                }
              )
            : V();
      ...
      B["UI_Loading"]["loadNextCG"](),
        "chs" != GameMgr["client_type"] || z["account"]["phone_verify"]
          ? d.run()
          : (B["UI_Entrance_Mail_Regist"].Inst["close"](),
            this["login_loading"]["close"](),
            (this["container_login"]["visible"] = !1),
            B["UI_Bind_Phone1"].Inst.show(
              !0,
              Laya["Handler"]["create"](this, function () {
                app["NetAgent"]["sendReq2Lobby"](
                  "Lobby",
                  ...
                  function (C, z) {
                    C || z["error"]
                      ? I["showError"](C, z["error"])
                      : 0 == z["phone_login"]
                      ? B["UI_Create_Phone_Account"].Inst.show(d)
                      : B["UI_Canot_Create_Phone_Account"].Inst.show(d);
                  }
                );
              })
            ));
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="text-center">雀魂Mod_Plus设置</h3>
            <object
              id="version"
          ...
          <div class="modal-body">
            <ul class="list-group">
              <li class="list-group-item">
                <dl class="row">
                  <dt class="col-sm-5">自定义名称</dt>
                  <dd class="col-sm-7">
                    <input
                      id="nickname"
                      type="text"
                      class="form-control rounded-3"
                      placeholder="留空则关闭该功能"
                    />
                  </dd>
                  <dt class="col-sm-5">开局后自动设置指定状态</dt>
                  <dd class="col-sm-7">
                    <div class="form-check form-switch">
                      <input
                        ...
                        type="checkbox"
                        role="switch"
                        data-bs-target="#setAuto"
                        data-bs-toggle="collapse"
                      />
                    </div>
                    <div id="setAuto" class="collapse">
                      <ul class="list-group">
                        <li class="list-group-item rounded-3">
                          <dl
                            class="row"
                            style="margin-bottom: calc(-0.5 * var(--bs-gutter-x))"
                          >
                            <dt class="col-5">自动理牌</dt>
                            <dd class="col-7">
                              <div class="form-check form-switch">
                                <input
                                  id="setAutoLiPai"
                  ...
                  <dd class="col-sm-7">
                    <div class="form-check form-switch">
                      <input
                        ...
                        type="checkbox"
                        role="switch"
                        data-bs-target="#setItems"
                        data-bs-toggle="collapse"
                      />
                    </div>
                    <div id="setItems" class="collapse">
                      <ul class="list-group">
                        <li class="list-group-item rounded-3">
                          <dl
                            class="row"
                            style="margin-bottom: calc(-0.5 * var(--bs-gutter-x))"
                          >
                            <dt class="col-5">不需要获得的道具ID</dt>
                            <dd class="col-7">
                              <textarea
                                id="ignoreItems"
                                class="form-control rounded-4 is-valid"
                                placeholder="使用英文逗号分隔，留空则关闭该功能"
                              ></textarea>
                              <div class="invalid-tooltip">输入有误！</div>
                            </dd>
                            <dt class="col-5">不获得活动道具</dt>
                            <dd class="col-7">
                              <div class="form-check form-switch">
                                <input
                                  id="ignoreEvent"
                  ...
                  <dd class="col-sm-7">
                    <div class="form-check form-switch">
                      <input
                        ...
                        type="text"
                        class="form-control rounded-3"
                        placeholder="输入皮肤ids,使用英文逗号分隔"
                      />
                    </div>
                  </dd>
                  <dt class="col-sm-5">随机默认皮肤玩家的皮肤</dt>
                  <dd class="col-sm-7">
                    <div class="form-check form-switch">
                      <input
                        id="randomPlayerDefSkin"
                        class="form-check-input"
                        type="checkbox"
                        role="switch"
                      />
                  ...
                  <dt class="col-sm-5">兼容mahjong-helper</dt>
                  <dd class="col-sm-7">
                    <div class="form-check form-switch">
                      <input
                        id="sendGame"
                        ...
                        type="checkbox"
                        role="switch"
                        data-bs-target="#sendGameSetting"
                        data-bs-toggle="collapse"
                      />
                      <svg
                    ...
                    <div id="sendGameSetting" class="collapse">
                      <ul class="list-group">
                        <li class="list-group-item rounded-3">
                          <dl
                            class="row"
                  ...
                  <dt class="col-sm-5">显示玩家所在服务器</dt>
                  <dd class="col-sm-7">
                    <div class="form-check form-switch">
                      <input
                        id="showServer"
                  ...
                  <dt class="col-sm-5">反屏蔽名称与文本审查</dt>
                  <dd class="col-sm-7">
                    <div class="form-check form-switch">
                      <input
                        id="antiCensorship"
                  ...
                  <dt class="col-sm-5">屏蔽挂机检测踢出游戏</dt>
                  <dd class="col-sm-7">
                    <div class="form-check form-switch">
                      <input
                        id="antiKickout"
              ...
              <li class="list-group-item list-group-item-warning">
                本脚本完全免费开源，如果您是付费获得，意味着您已经被倒卖狗骗了，请立即申请退款并差评！！
                <br />开源地址： <br />Github:
                <a
                  href="https://github.com/Avenshy/majsoul_mod_plus"
                  target="_blank"
                  >https://github.com/Avenshy/majsoul_mod_plus</a
                >
                <br />GreasyFork:
                <a
                  href="https://greasyfork.org/zh-CN/scripts/408051-%E9%9B%80%E9%AD%82mod-plus"
                  target="_blank"
                  >https://greasyfork.org/zh-CN/scripts/408051-%E9%9B%80%E9%AD%82mod-plus</a
                >
              </li>
            </ul>
          </div>
          <div class="modal-footer">
            <button id="saveSettings" type="button" class="btn btn-success">
              保存
            </button>
            <button
              type="button"
    ...
    >
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">雀魂Mod_Plus</h5>
            <button
              type="button"
              class="btn-close"
              data-bs-dismiss="modal"
    ...
    function openSettings() {
      if (MMP_Settings._isShown == false && saveSuccess._isShown == false) {
        ...
        document.querySelector("#skinIds").value =
          MMP.settings.skinIds?.join?.(",") || "";
    ...
    function saveSettings_UI() {
      ...
      MMP.settings.randomBotSkin =
        document.querySelector("#randomBotSkin").checked;
      const skinIdRawString = document.querySelector("#skinIds").value;
      MMP.settings.skinIds = skinIdRawString
        .replace("，", ",")
        .split(",")
        .map((s) => s.trim())
        .filter((s) => s.length > 0)
        .map((s) => parseInt(s));
      console.log("MMP.settings.skinIds: ", MMP.settings.skinIds);
